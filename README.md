...
[![CI](https://github.com/vladimiracunadev-create/marketing-sales-growth-evolution-program/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/vladimiracunadev-create/marketing-sales-growth-evolution-program/actions/workflows/ci.yml)
[![Pages](https://github.com/vladimiracunadev-create/marketing-sales-growth-evolution-program/actions/workflows/pages.yml/badge.svg?branch=main)](https://vladimiracunadev-create.github.io/marketing-sales-growth-evolution-program/)
...
```mermaid
flowchart LR
    A["Nivel 1 · Fundamentos<br/>Partes 01–04"] --> B["Nivel 2 · Oferta<br/>Partes 05–07"]
    B --> C["Nivel 3 · Venta<br/>Partes 08–11"]
    C --> D["Nivel 4 · Adquisición<br/>Partes 12–15"]
    D --> E["Nivel 5 · Operación<br/>Partes 16–18"]
    E --> F["Nivel 6 · Analítica<br/>Partes 19–20"]
    F --> G["Nivel 7 · IA y GTM<br/>Partes 21–22"]
    G --> H["Nivel 8 · Dirección<br/>Partes 23–24"]
```
...
python tools/build_fuentes.py          # docs/FUENTES.md, la página de fuentes
...
Texto completo y gratuito. **La norma vigente manda sobre el material pedagógico**: si una clase la contradice, gana la norma.

| Norma | Qué regula | Texto oficial |
|---|---|---|
| **Ley 19.496** | derechos del consumidor, publicidad engañosa, información y garantías | <https://www.bcn.cl/leychile/navegar?idNorma=61438> |
| **Ley 21.719** | tratamiento de datos personales, bases de licitud y derechos del titular | <https://www.bcn.cl/leychile/navegar?idNorma=1209272> |
...
[📚 Todas las fuentes](docs/FUENTES.md) · [Bibliografía por categoría](docs/BIBLIOGRAFIA.md) · [Registro con localizadores](sources/bibliography.json)
...
[![GitHub stars](https://img.shields.io/github/stars/vladimiracunadev-create/marketing-sales-growth-evolution-program?style=social)](https://github.com/vladimiracunadev-create/marketing-sales-growth-evolution-program/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/vladimiracunadev-create/marketing-sales-growth-evolution-program?style=social)](https://github.com/vladimiracunadev-create/marketing-sales-growth-evolution-program/network/members)
