...
>
> **Nivel de entrada:** Entrada a intermedio; es la puerta más accesible al área comercial para perfiles analíticos · **Foco:** Definición de métricas, cohortes, atribución, economía unitaria y tableros · **Señal de mercado:** Google Analytics · SQL · una prueba de incrementalidad ejecutada
...
1. 📚 [**Parte 01 — Marketing y ventas: fundamentos del sistema comercial**](../curriculum/part-01-marketing-y-ventas-fundamentos-del-sistema-comercial/README.md) · el motor de ingresos como sistema: sin este mapa, cada métrica flota sin contexto
2. 📚 [**Parte 20 — Analítica comercial y marketing science**](../curriculum/part-20-analitica-comercial-y-marketing-science/README.md) · **el núcleo del rol**: árbol de métricas, cohortes, atribución, incrementalidad y tableros
3. 📚 [**Parte 16 — CRM, pipeline y sales operations**](../curriculum/part-16-crm-pipeline-y-sales-operations/README.md) · cómo se produce el dato comercial y por qué el pipeline miente cuando no hay criterios de etapa
4. 📚 [**Parte 18 — Customer experience, success y fidelización**](../curriculum/part-18-customer-experience-success-y-fidelizacion/README.md) · retención, cohortes y el ingreso neto retenido, que es el indicador que más pesa
5. 📚 [**Parte 12 — Marketing digital y adquisición**](../curriculum/part-12-marketing-digital-y-adquisicion/README.md) · medición digital, plan de instrumentación y límites de cobertura por privacidad
6. 📚 [**Parte 19 — Growth marketing y growth engineering**](../curriculum/part-19-growth-marketing-y-growth-engineering/README.md) · diseño de experimentos y priorización con criterio previo
7. 📚 [**Parte 14 — Publicidad y performance marketing**](../curriculum/part-14-publicidad-y-performance-marketing/README.md) · economía de medios: CPA, CAC, ROAS y por qué se confunden

### Clases por las que empezar

- 🎯 [20.01 · Árbol de métricas](../curriculum/part-20-analitica-comercial-y-marketing-science/class-01-arbol-de-metricas.md) — Árbol de métricas: la descomposición que conecta cada trabajo con el ingreso
- 🎯 [20.02 · Conversión y embudos](../curriculum/part-20-analitica-comercial-y-marketing-science/class-02-conversion-y-funnels.md) — Conversión y embudos: por qué la misma etapa reporta 12 % o 34 %
- 🎯 [20.03 · Costo de adquisición de cliente](../curriculum/part-20-analitica-comercial-y-marketing-science/class-03-cac.md) — Costo de adquisición: el error de excluir sueldos comerciales
- 🎯 [20.07 · Análisis de cohortes aplicado](../curriculum/part-20-analitica-comercial-y-marketing-science/class-07-cohort-analysis.md) — Análisis de cohortes aplicado: distinguir mejora real de efecto de mezcla
- 🎯 [20.09 · Incrementalidad](../curriculum/part-20-analitica-comercial-y-marketing-science/class-09-incrementalidad.md) — Incrementalidad: la única pregunta que importa para decidir presupuesto
- 🎯 [20.10 · A/B testing](../curriculum/part-20-analitica-comercial-y-marketing-science/class-10-a-b-testing.md) — A/B testing: por qué la mayoría de las mejoras declaradas no se replican
- 🎯 [16.07 · Forecast](../curriculum/part-16-crm-pipeline-y-sales-operations/class-07-forecast.md) — Forecast: método declarado, sesgo medido y corrección aplicada
- 🎯 [18.09 · Análisis de cohortes](../curriculum/part-18-customer-experience-success-y-fidelizacion/class-09-cohortes.md) — Cohortes: comparar en el mismo hito de antigüedad
...
Analista → analista senior o especialista en un dominio (growth, retención, medios) → **RevOps** o **jefatura de analítica** → dirección de datos comerciales. Es también la mejor rampa hacia [growth](growth-manager.md) y [RevOps](revops.md), porque ambos exigen la misma base de rigor con el dato.
