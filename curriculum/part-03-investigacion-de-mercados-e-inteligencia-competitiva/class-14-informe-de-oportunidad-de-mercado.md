...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 03.13 — *Validación de hipótesis comerciales*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de afirmaciones trazables para calcular la línea base. |
