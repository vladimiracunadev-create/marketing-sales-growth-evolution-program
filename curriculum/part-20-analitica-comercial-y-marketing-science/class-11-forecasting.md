...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 20.10 — *A/B testing*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de precisión de proyecciones previas para calcular la línea base. |
