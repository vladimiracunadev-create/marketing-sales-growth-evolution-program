...
anchors: {"cagan": "descubrimiento", "ellis-brown": "ciclo", "kohavi": "confianza", "provost": "formulacion"}
updated: 2026-08-19
---
...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 19.11 — *Diseño de experimentos*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tiempo para lanzar un experimento para calcular la línea base. |
