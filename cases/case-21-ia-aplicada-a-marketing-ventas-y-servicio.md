---
title: "Caso 21 — IA aplicada a marketing, ventas y servicio"
type: case
language: es
part: 21
updated: 2026-08-19
...
- verificación del riesgo: publicar contenido incorrecto a escala, tratar datos personales sin base legal y perder trazabilidad.
...
Este caso integra la parte 21 y en particular la clase 21.14 — Operating model humano-IA. Su artefacto alimenta **operating model humano-IA con casos de uso, evaluaciones, guardrails y registro de incidentes**.

---

[⬅ Clases](../curriculum/part-21-ia-aplicada-a-marketing-ventas-y-servicio/README.md) · [Laboratorios](../labs/part-21/) · [Evaluación](../assessments/part-21-assessment.md)
