...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 07.07 — *Van Westendorp y técnicas de investigación de precio*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tasa de arbitraje para calcular la línea base. |
