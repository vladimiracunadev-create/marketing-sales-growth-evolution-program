...
- verificación del riesgo: incumplir derecho de retracto, garantía legal y reglas de información al consumidor.
...
Este caso integra la parte 15 y en particular la clase 15.14 — Simulación de tienda rentable. Su artefacto alimenta **simulación de tienda rentable con catálogo, checkout, costos y plan postventa**.

---

[⬅ Clases](../curriculum/part-15-e-commerce-y-marketplaces/README.md) · [Laboratorios](../labs/part-15/) · [Evaluación](../assessments/part-15-assessment.md)
