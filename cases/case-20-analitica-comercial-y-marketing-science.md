...
- verificación del riesgo: escalar inversión sobre una economía unitaria que no resiste una revisión financiera.
...
Este caso integra la parte 20 y en particular la clase 20.14 — Caso analítico integral. Su artefacto alimenta **caso analítico integral con árbol de métricas, cohortes, incrementalidad y dashboard ejecutivo**.

---

[⬅ Clases](../curriculum/part-20-analitica-comercial-y-marketing-science/README.md) · [Laboratorios](../labs/part-20/) · [Evaluación](../assessments/part-20-assessment.md)
