...
**Situación específica del laboratorio.** Las incorporaciones de Ruta Andina acompañan a un vendedor senior durante dos semanas y luego trabajan solas. La rampa promedio es siete meses.
...
Producir un componente defendible de **operating system del CRO con estructura, plan, cadencia, incentivos y reporte al directorio**, aplicando en particular **onboarding de equipos comerciales** y **OKR y KPI**.
...
1. Definir los componentes que la persona debe dominar.
2. Estructurar la secuencia con certificaciones.
3. Incorporar práctica supervisada temprana.
4. Medir la duración de la rampa por cohorte.
5. Corregir el programa con los datos de desempeño.
6. Calcular o diseñar la captura de **duración de la rampa**, **certificaciones aprobadas en plazo** y **desempeño a 6 meses**.
...
- Formar por observación sin certificación. Define componentes con verificación explícita y combina formación con práctica supervisada.
- Formular resultados clave como actividades. Reescribe cada resultado clave como un cambio medible con línea base y meta.
