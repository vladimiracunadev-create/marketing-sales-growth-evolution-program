---
title: "Parte 13 — Contenido, copywriting y comunicación persuasiva"
type: part-index
language: es
part: 13
updated: 2026-08-19
...
Esta parte trabaja el nivel **Adquisición** del programa y su propósito es que llegues a poder **producir mensajes que informen, muevan a la acción y resistan el escrutinio**. Llegas desde la parte 12, *Marketing digital y adquisición*, y lo que allí quedó resuelto se da por sabido aquí. Lo que produzcas aquí es material de entrada para la parte 14, *Publicidad y performance marketing*.

Son 14 clases, alrededor de 35 horas de estudio dirigido, y todas empujan hacia la misma pregunta:

> **¿Qué tiene que entender, creer y sentir esta persona para dar el siguiente paso?**

Esa pregunta no es retórica: al final de la parte tienes que poder responderla con un artefacto en la mano —sistema editorial con pilares, calendario, guía de estilo y piezas probadas— y no con una opinión.

## Sobre qué caso vas a trabajar

El blog de Ruta Andina publica dos artículos semanales sobre «tendencias digitales» y ninguno responde las preguntas que aparecen en las llamadas de venta.
...
Las competencias que se desarrollan aquí son **estrategia de contenidos**, **copywriting comercial** y **testing de mensajes**. Con ellas la parte habilita para el trabajo de Content manager, Copywriter y Product marketing, que es donde estas decisiones se toman de verdad.
...
|---|---|---|
| 01 | [Estrategia de contenidos](class-01-estrategia-de-contenidos.md) | audiencia definida, promesa editorial, ritmo sostenible |
| 02 | [Pilares de contenido](class-02-pilares-de-contenido.md) | pilar temático, autoridad real, conexión comercial |
| 03 | [AIDA](class-03-aida.md) | captura de atención, construcción de interés, deseo |
| 04 | [PAS: problema, agitación, solución](class-04-pas.md) | problema reconocible, agitación, solución proporcional |
| 05 | [Características versus beneficios](class-05-features-versus-benefits.md) | característica, beneficio, prueba |
| 06 | [Titulares](class-06-headlines.md) | especificidad, relevancia para el destinatario, honestidad del titular |
| 07 | [Ofertas y llamados a la acción](class-07-ofertas-y-cta.md) | proporcionalidad, claridad del compromiso, acción principal |
| 08 | [Copy de landing page](class-08-landing-page-copy.md) | jerarquía informativa, objeción dominante, prueba en página |
| 09 | [Copy de correo](class-09-email-copy.md) | contexto del destinatario, brevedad funcional, coherencia con el consentimiento |
| 10 | [Copy comercial B2B](class-10-sales-copy-b2b.md) | lector escéptico, precisión verificable, estructura de decisión |
| 11 | [Storytelling comercial](class-11-storytelling-comercial.md) | caso verificable, atribución honesta, protagonista reconocible |
| 12 | [Prueba social](class-12-prueba-social.md) | similitud del referente, verificabilidad, prueba social negativa |
| 13 | [Edición y testing de mensajes](class-13-edicion-y-testing-de-mensajes.md) | edición por utilidad, variable aislada, criterio previo |
| 14 | [Sistema editorial completo](class-14-sistema-editorial-completo.md) | flujo de producción, control de afirmaciones, biblioteca de piezas |

## Dónde se practica y cómo se evalúa

Leer la parte no la acredita. Los [laboratorios](../../labs/part-13/) te hacen ejecutar el método sobre el caso; la [evaluación de la parte](../../assessments/part-13-assessment.md) comprueba que puedes sostener las decisiones sin el material delante; el [caso extendido](../../cases/) exige integrar lo aprendido en una recomendación completa, y en [`templates/`](../../templates/) están los formatos que se usan para producir el artefacto. El resultado que va a tu portafolio es **sistema editorial con pilares, calendario, guía de estilo y piezas probadas**.

## Qué puede salir mal

Publicar afirmaciones no verificables o promesas comerciales que infrinjan la ley del consumidor. Antes de llevar cualquier recomendación de esta parte a una operación real, revisa el [mapa regulatorio](../../docs/MAPA-REGULATORIO-CHILE.md) y las [reglas sobre datos personales](../../docs/DATOS-PERSONALES-Y-ETICA.md): la norma vigente manda sobre el material pedagógico.
