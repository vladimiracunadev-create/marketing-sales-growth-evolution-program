...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 01.10 — *Ventas transaccionales y consultivas*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de time-to-value mediano para calcular la línea base. |
