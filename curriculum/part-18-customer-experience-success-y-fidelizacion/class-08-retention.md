...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 18.07 — *Churn*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de retención a 3, 6 y 12 meses para calcular la línea base. |
