...
- verificación del riesgo: confundir actividad con resultado y comprometer presupuesto antes de tener un diagnóstico.
...
Este caso integra la parte 01 y en particular la clase 01.14 — Mapa completo del motor de ingresos. Su artefacto alimenta **mapa del sistema comercial con supuestos, métricas y puntos de fuga**.

---

[⬅ Clases](../curriculum/part-01-marketing-y-ventas-fundamentos-del-sistema-comercial/README.md) · [Laboratorios](../labs/part-01/) · [Evaluación](../assessments/part-01-assessment.md)
