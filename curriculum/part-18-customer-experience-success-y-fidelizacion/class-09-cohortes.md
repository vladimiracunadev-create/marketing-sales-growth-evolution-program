...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 18.08 — *Retención*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de retención por cohorte en el mismo hito para calcular la línea base. |
