...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 18.04 — *Customer Success*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de capacidad predictiva del puntaje para calcular la línea base. |
