...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 02.12 — *Contexto cultural y social*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tamaño y estabilidad del segmento para calcular la línea base. |
