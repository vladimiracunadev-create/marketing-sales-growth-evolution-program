...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 16.04 — *Lead, contacto, cuenta y oportunidad*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tasa de datos obsoletos para calcular la línea base. |
