...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 20.12 — *Fundamentos de marketing mix modeling*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tiempo de lectura para calcular la línea base. |
