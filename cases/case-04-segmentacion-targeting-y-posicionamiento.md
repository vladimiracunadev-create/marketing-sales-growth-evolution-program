...
- verificación del riesgo: segmentar con variables decorativas que no cambian oferta, canal ni mensaje.
...
Este caso integra la parte 04 y en particular la clase 04.14 — Arquitectura STP completa. Su artefacto alimenta **arquitectura STP con criterios de atractivo, accesibilidad y declaración de posicionamiento probada**.

---

[⬅ Clases](../curriculum/part-04-segmentacion-targeting-y-posicionamiento/README.md) · [Laboratorios](../labs/part-04/) · [Evaluación](../assessments/part-04-assessment.md)
