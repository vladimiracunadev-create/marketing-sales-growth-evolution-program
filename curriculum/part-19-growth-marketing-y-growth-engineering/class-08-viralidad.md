...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 19.07 — *Bucles de referencia*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de coeficiente viral para calcular la línea base. |
