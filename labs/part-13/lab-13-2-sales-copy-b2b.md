---
title: "Lab 13.2 — Copy comercial B2B"
type: lab
language: es
part: 13
lab: 2
...
**Situación específica del laboratorio.** La propuesta de Ruta Andina para la cadena afirma «ahorro garantizado del 30 %» sin base de cálculo. Finanzas la rechazó por no poder verificar la cifra.
...
Producir un componente defendible de **sistema editorial con pilares, calendario, guía de estilo y piezas probadas**, aplicando en particular **copy comercial B2B** y **edición y testing de mensajes**.
...
1. Identificar al lector más escéptico del comité.
2. Escribir con precisión verificable y sin exageración.
3. Estructurar por problema, opciones y consecuencias.
4. Usar el vocabulario del cliente.
5. Probar el documento con alguien ajeno al negocio.
6. Calcular o diseñar la captura de **circulación interna del documento**, **afirmaciones verificables** y **preguntas de aclaración recibidas**.
...
- Usar cifras sin base de cálculo. Adjunta el método de cálculo y sus supuestos a toda afirmación cuantitativa.
- Cambiar varias variables a la vez. Aísla una variable por prueba y define el criterio de éxito antes de ejecutar.
