...
**Situación específica del laboratorio.** Ruta Andina usa la misma pieza desde hace cinco meses. La frecuencia semanal llegó a 11 y el costo por oportunidad se duplicó.
...
Producir un componente defendible de **plan de performance con estructura de campañas, presupuestos, medición y salvaguardas**, aplicando en particular **creatividades** y **linkedIn Ads: arquitectura conceptual**.
...
1. Investigar qué importa al destinatario antes de producir.
2. Definir el concepto y sus variantes.
3. Incluir activos distintivos de marca.
4. Monitorear la fatiga por frecuencia de exposición.
5. Renovar creatividades antes de la caída de desempeño.
6. Calcular o diseñar la captura de **desempeño por variante**, **frecuencia de exposición** y **atribución de marca**.
...
- Sostener la misma creatividad hasta que el resultado se desploma. Define un umbral de frecuencia y renueva antes de alcanzar la caída de desempeño.
- Usar canales caros para captar leads genéricos. Reserva el canal para propuestas pertinentes al rol y tickets que sostengan su costo.
