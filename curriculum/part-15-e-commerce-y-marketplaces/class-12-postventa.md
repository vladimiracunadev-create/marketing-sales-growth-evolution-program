...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 15.11 — *Marketplaces*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tiempo de resolución para calcular la línea base. |
