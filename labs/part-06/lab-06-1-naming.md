...
**Situación específica del laboratorio.** Ruta Andina descubre que un tercero registró un signo similar en la misma clase para servicios informáticos. La campaña de marca ya está contratada.
...
Producir un componente defendible de **brand book mínimo viable con activos distintivos, promesa y sistema de medición**, aplicando en particular **naming** y **arquitectura de marca**.
...
1. Definir criterios y territorio de uso antes de generar opciones.
2. Generar alternativas y filtrar por pronunciación y memoria.
3. Verificar disponibilidad registral y digital.
4. Probar comprensión y recuerdo con el segmento.
5. Decidir y proteger el signo elegido.
6. Calcular o diseñar la captura de **recuerdo correcto del nombre**, **disponibilidad registral** y **errores de escritura en búsquedas**.
...
- Invertir en identidad antes de verificar el registro. Consulta la disponibilidad en INAPI y en dominios antes de comprometer presupuesto de marca.
- Crear marcas nuevas por razones internas. Aplica el criterio de incompatibilidad de público, promesa o riesgo antes de aprobar una marca nueva.
