...
anchors: {"bush-plg": "autoservicio", "ellis-brown": "aha", "godin": "cambio", "weinberg-traction": "canales"}
updated: 2026-08-19
---

# Clase 19.08 — Viralidad

Clase 8 de 14 de la parte [19 — Growth marketing y growth engineering](README.md), de nivel Crecimiento y analítica. Dura unos 150 minutos.

## 🚦 Antes de empezar

Vienes de la clase 19.07, *Bucles de referencia*: ten a mano su entregable, porque esta sesión lo retoma y lo lleva más lejos.

Trabajarás sobre el caso de la clase. Si prefieres usar datos de tu organización, lo mínimo que necesitas es una serie histórica de coeficiente viral con la que calcular una línea base: sin ella podrás discutir el concepto, pero no comprobar si tu decisión mejora algo. Ten también dónde escribir —planilla o cuaderno— y, de la lectura comparada, al menos el índice y los capítulos que se indican al pie.
...
**Coeficiente viral** se entiende aquí como **número promedio de usuarios nuevos que genera cada usuario existente**.

La viralidad es un caso particular de bucle donde el uso del producto expone el producto a nuevos usuarios. Su parámetro central es cuántos usuarios nuevos genera cada usuario existente y en cuánto tiempo. Cuando ese factor es menor que uno, el mecanismo amplifica la adquisición pero no la sustituye.

**De dónde viene esta afirmación.** Sean Ellis y Morgan Brown — *Hacking Growth* (2017) aporta la idea que sostiene este bloque: el momento «ajá» identificado con datos y no supuesto. Búscala en los capítulos sobre el momento de valor. Aplicada a esta clase, esa idea predice algo verificable: si es correcta, «coeficiente viral» debería moverse cuando cambie **coeficiente viral**, y no debería moverse cuando cambie el resto. Ese es el contraste que tienes que montar antes de recomendar nada.
...
La viralidad parcial es la situación normal y la más útil de entender: un factor de amplificación moderado reduce significativamente el costo efectivo de adquisición aunque no produzca crecimiento autosostenido. Medirlo permite calcular ese efecto y ajustar la evaluación de los canales pagados en consecuencia.

**Contraste bibliográfico.** Wes Bush — *Product-Led Growth* (2019) aporta aquí una distinción concreta: las condiciones que hacen viable el autoservicio: valor perceptible sin asistencia (los capítulos sobre el modelo liderado por producto). Formula dos mini-casos: uno que satisface la definición de **tiempo de ciclo viral** y otro que sólo se le parece en la superficie; después decide cuál de los dos describiría esa obra con su propio vocabulario. Si la obra no permite separarlos, la distinción es tuya y tienes que sostenerla con evidencia del caso, no con la cita.
...
**Viralidad parcial** significa **contribución del mecanismo que reduce el costo de adquisición sin ser exponencial**.

El tiempo de ciclo viral es tan determinante como el factor: reducir el tiempo entre que un usuario entra y genera otro tiene un efecto multiplicativo mayor que aumentar marginalmente el factor. Identificar dónde está el retraso —en el momento de valor, en el mecanismo de compartir— es el análisis que orienta la intervención.
...
**Definición:** grado en que terceros observan que alguien usa el producto.

Forzar la viralidad con mecanismos intrusivos —solicitar acceso a contactos, publicar automáticamente— produce crecimiento inicial y daño reputacional. Esos mecanismos han sido restringidos por plataformas y por normativa, y su uso hoy es tanto un riesgo legal como comercial.

**Lo que aporta la fuente.** Seth Godin — *This Is Marketing* (2018) aporta el criterio para pesar el intercambio: el marketing como oferta de un cambio que alguien busca, no como difusión (los capítulos iniciales sobre qué es el marketing). Úsalo para construir una matriz `beneficio esperado / costo / reversibilidad / afectado / señal temprana`. La evidencia **efecto en costo de adquisición** ayuda a detectar si el intercambio está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.
...
La visibilidad del uso es la condición estructural de la viralidad: si el producto se usa en privado, no hay exposición y ningún incentivo la crea. Reconocer esa limitación evita invertir en programas virales que el producto no puede sostener, y redirige el esfuerzo hacia bucles de referencia explícita, que sí funcionan en productos no visibles.

**Frontera declarada.** Los mecanismos virales intrusivos —acceso a contactos, envíos automáticos— dañan la reputación y pueden infringir normas de datos personales. Conviértela en una regla operativa con el formato `si ocurre X → no aplicar automáticamente → consultar, escalar o revalidar`.
...
|---|---|---|---|
| Sean Ellis y Morgan Brown — *Hacking Growth* (2017) | El momento «ajá» identificado con datos y no supuesto | Los capítulos sobre el momento de valor | ¿Qué debería observarse en **coeficiente viral** si aquí opera «el momento «ajá» identificado con datos y no supuesto»? ¿Y qué observación lo desmentiría en este caso? |
| Wes Bush — *Product-Led Growth* (2019) | Las condiciones que hacen viable el autoservicio: valor perceptible sin asistencia | Los capítulos sobre el modelo liderado por producto | ¿Qué debería observarse en **tiempo de ciclo viral** si aquí opera «las condiciones que hacen viable el autoservicio: valor perceptible sin asistencia»? ¿Y qué observación lo desmentiría en este caso? |
| Gabriel Weinberg y Justin Mares — *Traction* (2015) | El catálogo de canales de tracción y el sesgo a repetir el que ya se conoce | Los capítulos que recorren cada canal | ¿Qué debería observarse en **viralidad parcial** si aquí opera «el catálogo de canales de tracción y el sesgo a repetir el que ya se conoce»? ¿Y qué observación lo desmentiría en este caso? |
| Seth Godin — *This Is Marketing* (2018) | El marketing como oferta de un cambio que alguien busca, no como difusión | Los capítulos iniciales sobre qué es el marketing | ¿Qué debería observarse en **visibilidad del uso** si aquí opera «el marketing como oferta de un cambio que alguien busca, no como difusión»? ¿Y qué observación lo desmentiría en este caso? |
...
| 2 | **Ejecutar el método** | Recorre la secuencia **medir el coeficiente y el tiempo de ciclo actuales → evaluar la visibilidad del uso para terceros → diseñar el mecanismo sólo si esa visibilidad existe → medir el efecto sobre el costo de adquisición → evitar mecanismos que degraden la experiencia** y adjunta la evidencia usada en cada transición. | La tabla del paso 1 | Cada paso deja un artefacto revisable y una alternativa descartada con su razón. |
| 3 | **Operacionalizar la señal** | Construye la ficha de medición de **coeficiente viral**; si el dato no existe, diseña cómo obtenerlo y estima cuánto costaría. | Fuentes de datos reales o el diseño de captura | Dos personas del equipo calculan el mismo número con la ficha y llegan al mismo resultado. |
| 4 | **Atacar tu propia respuesta** | Escribe la alternativa que contradice tu preferencia inicial y hazle un *pre-mortem* a seis meses. | Tu borrador de recomendación | Puedes nombrar el dato concreto que te haría cambiar de opinión. |
| 5 | **Contrastar con la fuente** | Lee la idea anclada de *Hacking Growth* y la de *Product-Led Growth*, y registra una coincidencia y una tensión con tu diagnóstico. | La tabla de lectura comparada | La nota de lectura cita qué idea usaste y qué decisión cambió por ella, o declara que ninguna cambió y por qué. |
...
| 2 | Dos observaciones concretas: una que confirmaría **viralidad parcial** y otra que te obligaría a abandonarlo. Una respuesta sin condición de refutación no es suficiente. |
| 3 | El dato faltante debe ser nombrable y obtenible: qué se mide, quién lo tiene y en cuánto tiempo. «Faltan datos» no cuenta como respuesta. |
| 4 | Debes distinguir asociación de causa y proponer al menos una explicación alternativa del mismo movimiento de **coeficiente viral**. |
| 5 | Identifica la condición del caso que decide entre ambas obras. Basta con que sea una: la respuesta correcta no es «depende», sino «depende de esto, y aquí ocurre así». Ancla el contraste en *Hacking Growth* y *This Is Marketing*. |
...
- Sean Ellis y Morgan Brown — [*Hacking Growth*](https://openlibrary.org/isbn/9780451497215) (2017) · ISBN 9780451497215 — **aporta a esta clase:** el momento «ajá» identificado con datos y no supuesto. **Dónde buscarlo:** los capítulos sobre el momento de valor. Registra edición y páginas consultadas en tu nota de lectura.
