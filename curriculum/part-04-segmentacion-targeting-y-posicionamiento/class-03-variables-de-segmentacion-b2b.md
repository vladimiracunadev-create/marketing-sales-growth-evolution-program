...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 04.02 — *Variables de segmentación B2C*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de margen por segmento para calcular la línea base. |
