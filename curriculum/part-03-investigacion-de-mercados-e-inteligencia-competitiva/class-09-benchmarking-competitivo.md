...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 03.08 — *TAM, SAM y SOM*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de brecha por atributo crítico para calcular la línea base. |
...
Los conceptos que estructuran la sesión son **tabla de entrada**, **punto de diferencia**, **brecha de desempeño** y **costo de cierre de brecha**. No se estudian como lista de vocabulario: cada uno debe producir una predicción distinta sobre lo que ocurriría en la operación.
...
|---|---|---|
| 0–15 min | Recuperación | Define **tabla de entrada** y **punto de diferencia** sin mirar el material; corrige después con la tabla de conceptos. |
| 15–45 min | Núcleo conceptual | Lectura del desarrollo y construcción de la tabla `hecho / inferencia / supuesto`. |
| 45–75 min | Medición | Ficha de la señal **brecha por atributo crítico**: fórmula, fuente, ventana y lectura prohibida. |
...
|---|---|---|
| **tabla de entrada** | atributo que todos los competidores ofrecen y cuya ausencia descalifica | Indica qué dato tendrías que ver para afirmarlo en una reunión de comité. |
| **punto de diferencia** | atributo donde la empresa supera de forma perceptible y sostenible a las alternativas | Traduce el concepto en una pregunta que puedas hacerle a un cliente real. |
| **brecha de desempeño** | diferencia medida entre la empresa y el mejor competidor en un atributo concreto | Da un hecho compatible con la definición y otro que la refute. |
| **costo de cierre de brecha** | recursos necesarios para alcanzar el nivel del competidor en ese atributo | Explica qué decisión cambiaría si el concepto estuviera ausente. |
...
**Frontera de aplicación.** El benchmarking mira el presente del competidor, no su dirección. Igualar hoy puede significar llegar tarde mañana si el competidor está construyendo otra cosa.

## 📖 Desarrollo

### 1. Tabla de entrada: mecanismo central
...
**Definición operacional:** atributo donde la empresa supera de forma perceptible y sostenible a las alternativas. Su valor está en distinguirlo de **tabla de entrada**.

La tabla de entrada reúne los atributos sin los cuales no te consideran, y el punto de diferencia es aquello por lo que te eligen entre los que sí consideran. Confundirlos lleva a invertir en diferenciarse en algo que todos ya tienen, o a descuidar un requisito básico creyendo que la diferencia compensa. La verificación es preguntar a clientes perdidos qué los dejó fuera de la lista corta.
...
### 4. Costo de cierre de brecha: trade-offs y efectos de segundo orden
...
Haz un *pre-mortem*: supón que la opción recomendada fracasó a los seis meses y enumera tres mecanismos que lo expliquen. Al menos uno debe provenir de un efecto de segundo orden asociado a **costo de cierre de brecha** y otro de un supuesto del caso que nunca fue validado.
...
**Frontera declarada.** El benchmarking mira el presente del competidor, no su dirección. Igualar hoy puede significar llegar tarde mañana si el competidor está construyendo otra cosa. Conviértela en una regla operativa con el formato `si ocurre X → no aplicar automáticamente → consultar, escalar o revalidar`.
...
Sintetizar benchmarking competitivo no consiste en sumar definiciones. Empieza por **tabla de entrada**, contrasta **punto de diferencia** con **brecha de desempeño**, incorpora **costo de cierre de brecha** como restricción y cierra con la medición. Aplica entonces la secuencia completa conservando tres columnas por paso: evidencia utilizada, alternativa descartada y razón del descarte.
...
|---|---|---|---|
| Michael E. Porter — *Competitive Strategy* (1980) | Los grupos estratégicos y las barreras de movilidad entre ellos | El capítulo sobre mapas de grupos estratégicos | ¿Qué debería observarse en **tabla de entrada** si aquí opera «los grupos estratégicos y las barreras de movilidad entre ellos»? ¿Y qué observación lo desmentiría en este caso? |
| Michael E. Porter — *What Is Strategy? (Harvard Business Review)* (1996) | La eficacia operativa no es estrategia: alcanzar la frontera de las mejores prácticas no diferencia | La primera sección del artículo | ¿Qué debería observarse en **punto de diferencia** si aquí opera «la eficacia operativa no es estrategia: alcanzar la frontera de las mejores prácticas no diferencia»? ¿Y qué observación lo desmentiría en este caso? |
| W. Chan Kim y Renée Mauborgne — *Blue Ocean Strategy* (2015, ed. ampliada) | La curva de valor como comparación explícita de atributos frente a la industria | El capítulo sobre el lienzo estratégico | ¿Qué debería observarse en **brecha de desempeño** si aquí opera «la curva de valor como comparación explícita de atributos frente a la industria»? ¿Y qué observación lo desmentiría en este caso? |
| Al Ries y Jack Trout — *Positioning: The Battle for Your Mind* (2001, ed. revisada) | La escalera de categoría: las marcas ocupan peldaños y desplazar al líder es caro | El capítulo sobre la escalera del producto | ¿Qué debería observarse en **costo de cierre de brecha** si aquí opera «la escalera de categoría: las marcas ocupan peldaños y desplazar al líder es caro»? ¿Y qué observación lo desmentiría en este caso? |
...
|---|---|---|---|
| Actuar sobre **tabla de entrada** | Atributo que todos los competidores ofrecen y cuya ausencia descalifica | Cuando **brecha por atributo crítico** es observable y accionable en el plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Actuar sobre **punto de diferencia** | Atributo donde la empresa supera de forma perceptible y sostenible a las alternativas | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
...
| Nivel | Responsabilidad sobre benchmarking competitivo |
|---|---|
...
Ruta Andina compara funcionalidades con dos competidores y concluye que necesita 14 desarrollos. Ninguno de los 14 aparece entre las razones de compra citadas por sus clientes ganados.
...
| 2 | Dos observaciones concretas: una que confirmaría **brecha de desempeño** y otra que te obligaría a abandonarlo. Una respuesta sin condición de refutación no es suficiente. |
| 3 | El dato faltante debe ser nombrable y obtenible: qué se mide, quién lo tiene y en cuánto tiempo. «Faltan datos» no cuenta como respuesta. |
| 4 | Debes distinguir asociación de causa y proponer al menos una explicación alternativa del mismo movimiento de **brecha por atributo crítico**. |
| 5 | Identifica la condición del caso que decide entre ambas obras. Basta con que sea una: la respuesta correcta no es «depende», sino «depende de esto, y aquí ocurre así». Ancla el contraste en *Competitive Strategy* y *Positioning: The Battle for Your Mind*. |
...
Guarda en `evidence/P03-C09-benchmarking-competitivo/`:

- `decision-brief.md` — problema, evidencia, alternativas, recomendación y gobierno.
- `ficha-metricas.md` — definición operacional de **brecha por atributo crítico**, **tasa de pérdida por atributo** y **costo estimado de paridad** con fuente, ventana y lectura prohibida.
...
- W. Chan Kim y Renée Mauborgne — *Blue Ocean Strategy* (2015, ed. ampliada) — **aporta a esta clase:** la curva de valor como comparación explícita de atributos frente a la industria. **Dónde buscarlo:** el capítulo sobre el lienzo estratégico. Registra edición y páginas consultadas en tu nota de lectura.
...
← [Clase 08 · TAM, SAM y SOM](class-08-tam-sam-y-som.md) · [Índice de la parte](README.md) · [Clase 10 · Análisis de competencia](class-10-analisis-de-competencia.md) →
