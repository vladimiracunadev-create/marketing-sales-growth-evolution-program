...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 19.09 — *Backlog de experimentos*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de calibración de estimaciones para calcular la línea base. |
