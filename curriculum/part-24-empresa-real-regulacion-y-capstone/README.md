...
Al terminar esta parte debes poder **integrar todo el programa en una operación comercial defendible y conforme a la normativa chilena**.

> **Pregunta rectora:** ¿Esta operación resiste una revisión comercial, financiera, legal y ética al mismo tiempo?
...
**Roles a los que habilita:** Founder, CRO, Consultor senior y Gerente general.
...
| Recurso | Ruta |
|---|---|
| Laboratorios | [`labs/part-24/`](../../labs/part-24/) |
| Evaluación de la parte | [`assessments/part-24-assessment.md`](../../assessments/part-24-assessment.md) |
| Caso extendido | [`cases/case-24-*.md`](../../cases/) |
| Plantillas | [`templates/`](../../templates/) |

**Artefacto de portafolio:** Capstone completo: empresa, evidencia, números, cumplimiento y defensa ejecutiva.

## Riesgo a vigilar

Presentar un plan atractivo que no cumple la Ley 19.496, la Ley 21.719 o las reglas de libre competencia. Revisa `docs/MAPA-REGULATORIO-CHILE.md` y `docs/DATOS-PERSONALES-Y-ETICA.md` antes de llevar cualquier recomendación a una operación real.
...
- William Ellet — *The Case Study Handbook* (2018, ed. revisada) — análisis de casos: problema, decisión, evidencia y recomendación.
