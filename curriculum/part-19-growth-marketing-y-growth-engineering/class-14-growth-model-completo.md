...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 19.13 — *Product-led growth*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de precisión del modelo para calcular la línea base. |
