...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 21.02 — *Prompting con contexto comercial*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de afirmaciones verificadas para calcular la línea base. |
...
- Andrew Ng — *Machine Learning Yearning* (2018) — **aporta a esta clase:** el diagnóstico de errores antes de elegir la siguiente mejora. **Dónde buscarlo:** los capítulos sobre análisis de error. Registra edición y páginas consultadas en tu nota de lectura.
