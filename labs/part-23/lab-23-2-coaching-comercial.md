...
**Situación específica del laboratorio.** La jefatura comercial de Ruta Andina dedica sus reuniones individuales a revisar el pipeline. Nunca ha escuchado una llamada completa de su equipo.
...
Producir un componente defendible de **operating system del CRO con estructura, plan, cadencia, incentivos y reporte al directorio**, aplicando en particular **coaching comercial** y **reporte al directorio**.

> **Pregunta que debe quedar respondida:** ¿Qué debe existir para que el resultado no dependa de que yo esté en cada reunión?

## Insumos

| Insumo | Ruta | Uso |
|---|---|---|
| Clases de la parte | [`curriculum/part-23-direccion-comercial-cmo-vp-sales-y-cro/`](../../curriculum/part-23-direccion-comercial-cmo-vp-sales-y-cro/) | Marco conceptual y método |
...
1. Observar interacciones reales con regularidad.
2. Identificar una habilidad específica por ciclo.
3. Entregar retroalimentación sobre comportamiento observable.
4. Practicar la habilidad en un ejercicio dirigido.
5. Verificar la mejora en la siguiente observación.
6. Calcular o diseñar la captura de **sesiones de acompañamiento por vendedor**, **mejora en la habilidad trabajada** y **relación acompañamiento-desempeño**.
7. Construir un escenario adverso: −30 % de presupuesto, −20 % de conversión o +25 % de duración del ciclo.
8. Verificar el riesgo declarado de la parte: Escalar un motor roto, generar rotación y destruir el margen mientras se «crece».
...
- Confundir revisión de pipeline con coaching. Reserva sesiones específicas de desarrollo basadas en observación real de interacciones.
- Reportar un riesgo cuando ya se materializó. Declara los riesgos relevantes en el reporte anterior a su posible materialización.
...
- Anders Ericsson y Robert Pool — *Peak* (2016) — práctica deliberada con criterios explícitos y retroalimentación inmediata.
...
[⬅ Laboratorios de la parte 23](./) · [Clases](../../curriculum/part-23-direccion-comercial-cmo-vp-sales-y-cro/README.md) · [Evaluación](../../assessments/part-23-assessment.md)
