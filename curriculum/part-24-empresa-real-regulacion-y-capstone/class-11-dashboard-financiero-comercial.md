...
### 1. Trazabilidad de la cifra: mecanismo central

**trazabilidad de la cifra** se entiende aquí como **posibilidad de reconstruir el cálculo desde sus componentes**. Es la pieza desde la que se inicia el análisis de dashboard financiero-comercial: antes de «definir los indicadores y su cálculo», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es Robert S. Kaplan y David P. Norton — *The Balanced Scorecard* (1996). **Lente que aporta:** traducción de la estrategia en indicadores causalmente conectados. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **cifras trazables**; regístrala con periodo, unidad, población y línea base.
...
### 2. Coherencia aritmética: frontera conceptual y error de clasificación

**Definición operacional:** consistencia entre los indicadores del tablero. Su valor está en distinguirlo de **trazabilidad de la cifra**. En una decisión real, clasificar mal una situación cambia la intervención: se asigna presupuesto donde faltaba diagnóstico, se mide un resultado cuando había que observar un proceso, o se trata una restricción como si fuera una preferencia.

Contrasta el problema con Alistair Croll y Benjamin Yoskovitz — *Lean Analytics* (2013) —**lente:** una métrica que importa por etapa y por modelo de negocio—. Formula dos mini-casos: uno que satisface la definición de **coherencia aritmética** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **coherencia aritmética verificada** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**proyección con supuestos** significa **estimación futura acompañada de las condiciones que la sostienen**. El problema ya no es definirlo sino medirlo: qué contar, en qué ventana, con qué denominador, contra qué línea base y con qué segmentación. Una métrica útil conserva contexto suficiente para no confundir una mejora local con una mejora del sistema.
...
**Definición:** métrica con umbral definido que gatilla una acción. Este concepto obliga a abandonar la idea de que dashboard financiero-comercial tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «declarar los supuestos de la proyección», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

Avinash Kaushik — *Web Analytics 2.0* (2009) —**lente:** medición orientada a decisión, segmentación y crítica del dato de vanidad— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **indicadores con umbral** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.
...
Avinash Kaushik — *Web Analytics 2.0* (2009) sirve para contrastar la recomendación final desde otro lente: medición orientada a decisión, segmentación y crítica del dato de vanidad. La frontera de esta clase es explícita: Un tablero con datos simulados demuestra diseño, no desempeño. Debe declararse el origen de cada serie utilizada. Conviértela en una regla operativa con el formato `si ocurre X → no aplicar automáticamente → consultar, escalar o revalidar`.
...
2. Ejecuta la secuencia **definir los indicadores y su cálculo → construir el tablero con datos del proyecto → verificar la coherencia aritmética del conjunto → declarar los supuestos de la proyección → definir umbrales de alerta y sus acciones** y adjunta evidencia en cada transición.
...
← [Clase 10 · Customer Success del Capstone](class-10-customer-success.md) · [Índice de la parte](README.md) · [Clase 12 · Cumplimiento normativo en Chile](class-12-cumplimiento-chile.md) →
