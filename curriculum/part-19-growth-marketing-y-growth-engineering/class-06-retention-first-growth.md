...
anchors: {"croll-yoskovitz": "una-metrica", "ellis-brown": "must-have", "fader": "centricidad", "mehta": "salud"}
updated: 2026-08-19
---
...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 19.05 — *Activación*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de nivel de estabilización de la curva para calcular la línea base. |
