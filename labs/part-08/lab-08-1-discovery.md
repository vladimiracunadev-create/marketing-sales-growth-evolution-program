...
**Situación específica del laboratorio.** Un taller de Valparaíso pierde seis citas semanales. El vendedor de Ruta Andina nunca preguntó cuánto factura una cita ni qué pasa cuando el cliente no vuelve.
...
Producir un componente defendible de **playbook comercial con etapas, criterios de salida, guiones y materiales**, aplicando en particular **discovery** y **presentaciones comerciales**.
...
1. Documentar la situación actual con datos del cliente.
2. Identificar el problema en las palabras del cliente.
3. Explorar implicaciones sin sugerir la solución.
4. Cuantificar el costo de no actuar.
5. Confirmar el diagnóstico por escrito antes de proponer.
6. Calcular o diseñar la captura de **costo de no actuar cuantificado**, **preguntas de implicación por reunión** y **tasa de cierre con diagnóstico confirmado**.
...
- Proponer solución antes de cuantificar el problema. Exige una cifra estimada por el cliente antes de pasar a la demostración.
- Estructurar la presentación desde la empresa. Abre con el problema del cliente y su costo, y deja la credencial institucional en anexo.
