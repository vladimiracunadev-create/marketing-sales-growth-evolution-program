...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 08.02 — *Prospección*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de proporción de tiempo hablado por el cliente para calcular la línea base. |
...
- Chris Voss y Tahl Raz — *Never Split the Difference* (2016) — **aporta a esta clase:** la técnica del espejo para sostener el turno y obtener elaboración. **Dónde buscarlo:** el capítulo sobre reflejo. Registra edición y páginas consultadas en tu nota de lectura.
- Keenan — *Gap Selling* (2018) — **aporta a esta clase:** la reconstrucción factual del estado actual antes de proyectar el futuro. **Dónde buscarlo:** los capítulos sobre descubrimiento del estado actual. Registra edición y páginas consultadas en tu nota de lectura.
