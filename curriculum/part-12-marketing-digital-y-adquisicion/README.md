...
> **¿Qué activo digital genera demanda propia y qué parte del resultado es alquilada?**

Esa pregunta no es retórica: al final de la parte tienes que poder responderla con un artefacto en la mano —plan de adquisición digital con arquitectura de sitio, canales, medición y auditoría inicial— y no con una opinión.
...
Las competencias que se desarrollan aquí son **estrategia digital**, **conversión web** y **analítica y atribución básica**. Con ellas la parte habilita para el trabajo de Digital marketing manager, Growth marketer y Especialista SEO/SEM, que es donde estas decisiones se toman de verdad.
...
Leer la parte no la acredita. Los [laboratorios](../../labs/part-12/) te hacen ejecutar el método sobre el caso; la [evaluación de la parte](../../assessments/part-12-assessment.md) comprueba que puedes sostener las decisiones sin el material delante; el [caso extendido](../../cases/) exige integrar lo aprendido en una recomendación completa, y en [`templates/`](../../templates/) están los formatos que se usan para producir el artefacto. El resultado que va a tu portafolio es **plan de adquisición digital con arquitectura de sitio, canales, medición y auditoría inicial**.
