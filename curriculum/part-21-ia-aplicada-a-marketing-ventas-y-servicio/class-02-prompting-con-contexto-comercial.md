...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 21.01 — *Mapa de IA comercial*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tasa de aceptación de salidas para calcular la línea base. |
