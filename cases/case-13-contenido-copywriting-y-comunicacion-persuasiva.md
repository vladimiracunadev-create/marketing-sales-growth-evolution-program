...
- verificación del riesgo: publicar afirmaciones no verificables o promesas comerciales que infrinjan la ley del consumidor.
...
Este caso integra la parte 13 y en particular la clase 13.14 — Sistema editorial completo. Su artefacto alimenta **sistema editorial con pilares, calendario, guía de estilo y piezas probadas**.

---

[⬅ Clases](../curriculum/part-13-contenido-copywriting-y-comunicacion-persuasiva/README.md) · [Laboratorios](../labs/part-13/) · [Evaluación](../assessments/part-13-assessment.md)
