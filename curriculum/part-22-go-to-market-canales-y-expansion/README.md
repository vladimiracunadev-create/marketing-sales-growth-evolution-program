...
> **¿Qué movimiento comercial corresponde al valor del contrato, al ciclo y al comprador?**

Esa pregunta no es retórica: al final de la parte tienes que poder responderla con un artefacto en la mano —plan GTM completo con beachhead, movimiento comercial, canales, economía y plan de lanzamiento— y no con una opinión.
...
Las competencias que se desarrollan aquí son **selección de movimiento GTM**, **economía de canales** y **planificación de lanzamiento**. Con ellas la parte habilita para el trabajo de Head of GTM, Partnerships, Product marketing y Founder, que es donde estas decisiones se toman de verdad.
...
|---|---|---|
| 01 | [Qué es una estrategia go-to-market](class-01-que-es-una-estrategia-gtm.md) | movimiento comercial, coherencia económica, segmento objetivo |
| 02 | [Entrada a un mercado](class-02-market-entry.md) | demanda verificable, capacidad de servir, camino de acceso |
| 03 | [Beachhead market](class-03-beachhead-market.md) | cabeza de playa, masa crítica, circulación de referencias |
| 04 | [Crecimiento liderado por ventas](class-04-sales-led-growth.md) | costo del equipo comercial, productividad por vendedor, latencia de escalamiento |
| 05 | [Crecimiento liderado por producto](class-05-product-led-growth.md) | adopción autónoma, expansión por uso, costo de servir en autoservicio |
| 06 | [Crecimiento liderado por socios](class-06-partner-led-growth.md) | incentivo del socio, habilitación, socio activo |
| 07 | [Canales directos e indirectos](class-07-canales-directos-e-indirectos.md) | canal directo, canal indirecto, regla de conflicto |
| 08 | [Economía de canales](class-08-channel-economics.md) | margen retenido, costo de habilitación, velocidad de escalamiento |
| 09 | [Lanzamientos](class-09-lanzamientos.md) | preparación interna, criterio de listeza, nivel de lanzamiento |
| 10 | [Expansión geográfica](class-10-expansion-geografica.md) | costo de presencia local, cumplimiento local, referencias locales |
| 11 | [Expansión por segmento](class-11-expansion-por-segmento.md) | adyacencia real, transferencia de credibilidad, ajuste operativo |
| 12 | [Internacionalización](class-12-internacionalizacion.md) | modo de entrada, complejidad regulatoria, costo de coordinación |
| 13 | [Métricas de go-to-market](class-13-gtm-metrics.md) | eficiencia del crecimiento, productividad por movimiento, contribución por canal |
| 14 | [Plan go-to-market completo](class-14-plan-gtm-completo.md) | coherencia del plan, secuencia de expansión, criterio de expansión |

## Dónde se practica y cómo se evalúa

Leer la parte no la acredita. Los [laboratorios](../../labs/part-22/) te hacen ejecutar el método sobre el caso; la [evaluación de la parte](../../assessments/part-22-assessment.md) comprueba que puedes sostener las decisiones sin el material delante; el [caso extendido](../../cases/) exige integrar lo aprendido en una recomendación completa, y en [`templates/`](../../templates/) están los formatos que se usan para producir el artefacto. El resultado que va a tu portafolio es **plan GTM completo con beachhead, movimiento comercial, canales, economía y plan de lanzamiento**.

## Qué puede salir mal

Abrir frentes simultáneos sin capacidad, diluir foco y llegar tarde a todos. Antes de llevar cualquier recomendación de esta parte a una operación real, revisa el [mapa regulatorio](../../docs/MAPA-REGULATORIO-CHILE.md) y las [reglas sobre datos personales](../../docs/DATOS-PERSONALES-Y-ETICA.md): la norma vigente manda sobre el material pedagógico.
