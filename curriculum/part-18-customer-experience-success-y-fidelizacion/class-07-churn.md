...
anchors: {"croll-yoskovitz": "cohortes", "fader": "heterogeneidad", "mehta": "leyes", "reichheld": "cierre-circuito"}
updated: 2026-08-19
---
...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 18.06 — *NPS, CSAT y CES*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de churn de ingreso mensual para calcular la línea base. |
