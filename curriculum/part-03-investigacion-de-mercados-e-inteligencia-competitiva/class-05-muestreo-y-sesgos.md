...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 03.04 — *Diseño de encuestas*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de cobertura del marco muestral para calcular la línea base. |
