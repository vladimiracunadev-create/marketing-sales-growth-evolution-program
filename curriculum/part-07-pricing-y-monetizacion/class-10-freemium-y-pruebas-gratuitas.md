...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 07.09 — *Suscripción e ingreso recurrente*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tasa de conversión a pago para calcular la línea base. |
...
- Wes Bush — *Product-Led Growth* (2019) — **aporta a esta clase:** la elección entre prueba gratuita y plan libre según el producto. **Dónde buscarlo:** los capítulos sobre modelos de acceso. Registra edición y páginas consultadas en tu nota de lectura.
