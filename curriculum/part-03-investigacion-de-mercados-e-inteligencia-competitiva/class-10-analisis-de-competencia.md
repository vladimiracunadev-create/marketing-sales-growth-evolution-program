...
Vienes de la clase 03.09, *Benchmarking competitivo*: ten a mano su entregable, porque esta sesión lo retoma y lo lleva más lejos.

Trabajarás sobre el caso de la clase. Si prefieres usar datos de tu organización, lo mínimo que necesitas es una serie histórica de participación en negocios enfrentados con la que calcular una línea base: sin ella podrás discutir el concepto, pero no comprobar si tu decisión mejora algo. Ten también dónde escribir —planilla o cuaderno— y, de la lectura comparada, al menos el índice y los capítulos que se indican al pie.

Calcula 150 minutos de trabajo dirigido más una hora de lectura selectiva. Sabrás que terminaste cuando exista el entregable y puedas responder las seis preguntas de comprobación sin volver al texto; si tienes el entregable pero no las respuestas, lo que produjiste es un documento, no un criterio.

Lee el propósito y la agenda antes que el desarrollo. La agenda dice qué debe salir de cada tramo, y el desarrollo se entiende mejor cuando ya sabes qué artefacto tiene que producir. No avances de sección sin escribir algo: este material está hecho para dejar decisiones documentadas, no notas de lectura.

**La idea que ordena la sesión.** El análisis del competidor por sus objetivos, supuestos y capacidades, no por su catálogo — Michael E. Porter. Todo lo demás en esta clase existe para poner esa idea a prueba contra un caso concreto.
...
Los conceptos que estructuran la sesión son **modelo económico del competidor**, **restricción del competidor**, **movimiento probable** y **intensidad competitiva**. No se estudian como lista de vocabulario: cada uno debe producir una predicción distinta sobre lo que ocurriría en la operación.
...
|---|---|---|
| 0–15 min | Recuperación | Define **modelo económico del competidor** y **restricción del competidor** sin mirar el material; corrige después con la tabla de conceptos. |
| 15–45 min | Núcleo conceptual | Lectura del desarrollo y construcción de la tabla `hecho / inferencia / supuesto`. |
| 45–75 min | Medición | Ficha de la señal **participación en negocios enfrentados**: fórmula, fuente, ventana y lectura prohibida. |
...
|---|---|---|
| **modelo económico del competidor** | forma en que gana dinero, su estructura de costos y su presión de retorno | Traduce el concepto en una pregunta que puedas hacerle a un cliente real. |
| **restricción del competidor** | limitación de capital, capacidad, contrato o tecnología que acota lo que puede hacer | Da un hecho compatible con la definición y otro que la refute. |
| **movimiento probable** | acción esperable del competidor dada su situación, no la que sería óptima en abstracto | Explica qué decisión cambiaría si el concepto estuviera ausente. |
| **intensidad competitiva** | grado en que la rivalidad erosiona el margen disponible en la categoría | Construye un caso límite donde el concepto se confunde con el anterior. |
...
**Frontera de aplicación.** La inteligencia competitiva tiene límites legales y éticos: no incluye obtener información confidencial por medios engañosos ni coordinar precios, práctica sancionada por la libre competencia en Chile.

## 📖 Desarrollo

### 1. Modelo económico del competidor: mecanismo central
...
Relaciona el mecanismo con **restricción del competidor**. Si ambos se mueven juntos no concluyas causalidad: nombra una tercera variable capaz de explicar el mismo patrón. El resultado de este bloque debe ser una hipótesis refutable, no una recomendación anticipada.

### 2. Restricción del competidor: frontera conceptual y error de clasificación

**Definición operacional:** limitación de capital, capacidad, contrato o tecnología que acota lo que puede hacer. Su valor está en distinguirlo de **modelo económico del competidor**.

La restricción del competidor es lo que no puede hacer aunque quiera, y es el dato más accionable del análisis. Una empresa con arquitectura antigua no puede bajar su costo de servir; una con inversionistas que exigen crecimiento no puede sostener un nicho pequeño. Identificar esas restricciones permite elegir terreno: se compite donde el otro está impedido de responder, no donde es simplemente peor.
...
**Control de lectura.** W. Chan Kim y Renée Mauborgne — *Blue Ocean Strategy* (2015, ed. ampliada) pone una condición sobre la medición: los no clientes como fuente de crecimiento por encima de la competencia por los actuales (el capítulo sobre los tres niveles de no clientes). Contrasta tu ficha con ella: si la métrica que acabas de definir cae dentro de lo que esa obra considera un error de medición, corrígela antes de usarla para decidir.

### 4. Intensidad competitiva: trade-offs y efectos de segundo orden

**Definición:** grado en que la rivalidad erosiona el margen disponible en la categoría.

Vigilar de cerca al competidor mejora la anticipación y arrastra la agenda propia hacia la suya. Los equipos que revisan semanalmente los movimientos del rival terminan construyendo lo que el rival construye. La disciplina consiste en fijar una frecuencia acotada de revisión y una regla explícita sobre qué tipo de movimiento ajeno justifica cambiar el plan propio.

**Lo que aporta la fuente.** Michael E. Porter — *What Is Strategy? (Harvard Business Review)* (1996) aporta el criterio para pesar el intercambio: la elección estratégica implica renunciar deliberadamente a opciones (la sección sobre trade-offs). Úsalo para construir una matriz `beneficio esperado / costo / reversibilidad / afectado / señal temprana`. La evidencia **velocidad de respuesta** ayuda a detectar si el intercambio está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.

Haz un *pre-mortem*: supón que la opción recomendada fracasó a los seis meses y enumera tres mecanismos que lo expliquen. Al menos uno debe provenir de un efecto de segundo orden asociado a **intensidad competitiva** y otro de un supuesto del caso que nunca fue validado.
...
Sintetizar análisis de competencia no consiste en sumar definiciones. Empieza por **modelo económico del competidor**, contrasta **restricción del competidor** con **movimiento probable**, incorpora **intensidad competitiva** como restricción y cierra con la medición. Aplica entonces la secuencia completa conservando tres columnas por paso: evidencia utilizada, alternativa descartada y razón del descarte.
...
|---|---|---|---|
| Michael E. Porter — *Competitive Strategy* (1980) | El análisis del competidor por sus objetivos, supuestos y capacidades, no por su catálogo | El capítulo sobre análisis de la competencia | ¿Qué debería observarse en **modelo económico del competidor** si aquí opera «el análisis del competidor por sus objetivos, supuestos y capacidades, no por su catálogo»? ¿Y qué observación lo desmentiría en este caso? |
| Richard Rumelt — *Good Strategy / Bad Strategy* (2011) | El diagnóstico como reformulación del problema que hace evidente la acción | El capítulo sobre el diagnóstico | ¿Qué debería observarse en **restricción del competidor** si aquí opera «el diagnóstico como reformulación del problema que hace evidente la acción»? ¿Y qué observación lo desmentiría en este caso? |
| W. Chan Kim y Renée Mauborgne — *Blue Ocean Strategy* (2015, ed. ampliada) | Los no clientes como fuente de crecimiento por encima de la competencia por los actuales | El capítulo sobre los tres niveles de no clientes | ¿Qué debería observarse en **movimiento probable** si aquí opera «los no clientes como fuente de crecimiento por encima de la competencia por los actuales»? ¿Y qué observación lo desmentiría en este caso? |
| Michael E. Porter — *What Is Strategy? (Harvard Business Review)* (1996) | La elección estratégica implica renunciar deliberadamente a opciones | La sección sobre trade-offs | ¿Qué debería observarse en **intensidad competitiva** si aquí opera «la elección estratégica implica renunciar deliberadamente a opciones»? ¿Y qué observación lo desmentiría en este caso? |
...
|---|---|---|---|
| Actuar sobre **modelo económico del competidor** | Forma en que gana dinero, su estructura de costos y su presión de retorno | Cuando **participación en negocios enfrentados** es observable y accionable en el plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Actuar sobre **restricción del competidor** | Limitación de capital, capacidad, contrato o tecnología que acota lo que puede hacer | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
...
| Nivel | Responsabilidad sobre análisis de competencia |
|---|---|
...
El competidor regional de Ruta Andina levantó capital y bajó precios 30 %. La reacción propuesta es igualar el precio, sin considerar que el competidor puede sostener pérdidas y Ruta Andina no.
...
| 2 | Dos observaciones concretas: una que confirmaría **movimiento probable** y otra que te obligaría a abandonarlo. Una respuesta sin condición de refutación no es suficiente. |
| 3 | El dato faltante debe ser nombrable y obtenible: qué se mide, quién lo tiene y en cuánto tiempo. «Faltan datos» no cuenta como respuesta. |
| 4 | Debes distinguir asociación de causa y proponer al menos una explicación alternativa del mismo movimiento de **participación en negocios enfrentados**. |
| 5 | Identifica la condición del caso que decide entre ambas obras. Basta con que sea una: la respuesta correcta no es «depende», sino «depende de esto, y aquí ocurre así». Ancla el contraste en *Competitive Strategy* y *What Is Strategy? (Harvard Business Review)*. |
...
Guarda en `evidence/P03-C10-analisis-de-competencia/`:

- `decision-brief.md` — problema, evidencia, alternativas, recomendación y gobierno.
- `ficha-metricas.md` — definición operacional de **participación en negocios enfrentados**, **cambios de precio del competidor** y **velocidad de respuesta** con fuente, ventana y lectura prohibida.
...
← [Clase 09 · Benchmarking competitivo](class-09-benchmarking-competitivo.md) · [Índice de la parte](README.md) · [Clase 11 · Social listening y señales de mercado](class-11-social-listening-y-senales-de-mercado.md) →
