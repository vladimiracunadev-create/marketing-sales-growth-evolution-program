...
- verificación del riesgo: tomar decisiones de contratación y presupuesto sobre un pipeline que no representa la realidad.
...
Este caso integra la parte 16 y en particular la clase 16.14 — Diseño de sales operations. Su artefacto alimenta **diseño de sales operations con pipeline, criterios de etapa, forecast y gobierno de datos**.

---

[⬅ Clases](../curriculum/part-16-crm-pipeline-y-sales-operations/README.md) · [Laboratorios](../labs/part-16/) · [Evaluación](../assessments/part-16-assessment.md)
