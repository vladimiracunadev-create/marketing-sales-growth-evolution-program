...
1. **Distinguir** `situación actual`, `problema declarado`, `implicación` y `costo de no actuar` por sus observables y no por su definición memorizada.
2. **Explicar** por qué esas distinciones cambian una decisión concreta dentro de **Fundamentos profesionales de ventas**.
3. **Aplicar** la secuencia **documentar la situación actual con datos del cliente → identificar el problema en las palabras del cliente → explorar implicaciones sin sugerir la solución → cuantificar el costo de no actuar → confirmar el diagnóstico por escrito antes de proponer** conservando supuestos, alternativas descartadas y trazabilidad.
4. **Operacionalizar** **costo de no actuar cuantificado**, **preguntas de implicación por reunión** y **tasa de cierre con diagnóstico confirmado** indicando numerador, denominador, ventana, fuente y uso permitido.
...
1. Explica la diferencia entre **situación actual** y **problema declarado** con un ejemplo donde elegir mal cambie la decisión.
2. ¿Qué observarías para validar **implicación** y qué observación te obligaría a rechazar tu interpretación?
3. Aplica «documentar la situación actual con datos del cliente» al caso de la clase. ¿Qué dato sigue faltando?
...
- `ficha-metricas.md` — definición operacional de **costo de no actuar cuantificado**, **preguntas de implicación por reunión** y **tasa de cierre con diagnóstico confirmado** con fuente, ventana y lectura prohibida.
...
← [Clase 03 · Apertura y rapport](class-03-apertura-y-rapport.md) · [Índice de la parte](README.md) · [Clase 05 · Calificación de oportunidades](class-05-calificacion-de-oportunidades.md) →
