...
**marco muestral** se entiende aquí como **lista o mecanismo desde el cual se seleccionan los participantes**. Es la pieza desde la que se inicia el análisis de muestreo y sesgos: antes de «definir la población objetivo con precisión», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es Naresh K. Malhotra — *Marketing Research: An Applied Orientation* (2019, 7.ª ed.). **Lente que aporta:** diseño de investigación, muestreo, medición y análisis con rigor metodológico. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **cobertura del marco muestral**; regístrala con periodo, unidad, población y línea base.
...
**Definición operacional:** diferencia sistemática entre quienes participan y quienes no, relacionada con la variable estudiada. Su valor está en distinguirlo de **marco muestral**. En una decisión real, clasificar mal una situación cambia la intervención: se asigna presupuesto donde faltaba diagnóstico, se mide un resultado cuando había que observar un proceso, o se trata una restricción como si fuera una preferencia.

Contrasta el problema con Foster Provost y Tom Fawcett — *Data Science for Business* (2013) —**lente:** pensamiento analítico: formulación del problema, evaluación y valor esperado—. Formula dos mini-casos: uno que satisface la definición de **sesgo de selección** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **diferencia entre respondentes y no respondentes** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**Definición:** situación en que quienes no responden difieren sistemáticamente de quienes sí responden. Este concepto obliga a abandonar la idea de que muestreo y sesgos tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «estimar quién queda fuera y cómo podría diferir», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

Ron Kohavi, Diane Tang y Ya Xu — *Trustworthy Online Controlled Experiments* (2020) —**lente:** diseño estadístico de experimentos, métricas guardrail y trampas de interpretación— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **intervalo de confianza declarado** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.
...
2. Ejecuta la secuencia **definir la población objetivo con precisión → describir el marco muestral y sus exclusiones → elegir el método de selección y justificarlo → estimar quién queda fuera y cómo podría diferir → declarar los límites de extrapolación en el informe** y adjunta evidencia en cada transición.
3. Construye la ficha de medición de **cobertura del marco muestral**; si el dato no existe, diseña cómo obtenerlo y cuánto costaría.
