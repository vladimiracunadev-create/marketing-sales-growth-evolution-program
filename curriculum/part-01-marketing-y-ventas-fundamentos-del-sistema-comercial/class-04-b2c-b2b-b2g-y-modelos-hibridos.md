...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 01.03 — *Mercados, categorías y competencia*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de ciclo de compra mediano para calcular la línea base. |
