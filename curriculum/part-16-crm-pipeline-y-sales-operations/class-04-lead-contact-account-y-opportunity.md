...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 16.03 — *Etapas y criterios de salida*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de duplicados de cuenta para calcular la línea base. |
