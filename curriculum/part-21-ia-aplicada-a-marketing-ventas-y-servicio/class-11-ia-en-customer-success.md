...
**predicción de riesgo** se entiende aquí como **estimación automatizada de la probabilidad de baja de una cuenta**. Es la pieza desde la que se inicia el análisis de IA en customer success: antes de «usar modelos para predecir y priorizar», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es Nick Mehta, Dan Steinman y Lincoln Murphy — *Customer Success* (2016). **Lente que aporta:** disciplina operativa de éxito de cliente: salud, renovación y expansión. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **precisión de la predicción de baja**; regístrala con periodo, unidad, población y línea base.
...
**Definición operacional:** ordenamiento de cuentas por riesgo y valor para asignar atención. Su valor está en distinguirlo de **predicción de riesgo**. En una decisión real, clasificar mal una situación cambia la intervención: se asigna presupuesto donde faltaba diagnóstico, se mide un resultado cuando había que observar un proceso, o se trata una restricción como si fuera una preferencia.

Contrasta el problema con Matthew Dixon, Nick Toman y Rick DeLisi — *The Effortless Experience* (2013) —**lente:** reducción del esfuerzo del cliente como motor de lealtad frente al deleite—. Formula dos mini-casos: uno que satisface la definición de **priorización de cartera** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **tasa de escalamiento a persona** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**automatización de la respuesta** significa **sustitución de la interacción humana por un sistema**. El problema ya no es definirlo sino medirlo: qué contar, en qué ventana, con qué denominador, contra qué línea base y con qué segmentación. Una métrica útil conserva contexto suficiente para no confundir una mejora local con una mejora del sistema.
...
**Definición:** condición que obliga a que una persona tome la conversación. Este concepto obliga a abandonar la idea de que IA en customer success tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «medir efecto en retención y en satisfacción», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

NIST — *AI Risk Management Framework 1.0* (2023) —**lente:** gobernanza de riesgo de IA: mapear, medir, gestionar y gobernar— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **satisfacción por tipo de atención** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.
...
2. Ejecuta la secuencia **usar modelos para predecir y priorizar → definir el momento de escalamiento a una persona → mantener humana la conversación de riesgo o reclamo → medir efecto en retención y en satisfacción → revisar los casos escalados para corregir el diseño** y adjunta evidencia en cada transición.
3. Construye la ficha de medición de **precisión de la predicción de baja**; si el dato no existe, diseña cómo obtenerlo y cuánto costaría.
