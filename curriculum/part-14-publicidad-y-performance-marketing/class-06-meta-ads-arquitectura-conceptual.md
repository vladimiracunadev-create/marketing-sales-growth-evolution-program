...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 14.05 — *Google Ads: arquitectura conceptual*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de conversiones semanales por conjunto para calcular la línea base. |
