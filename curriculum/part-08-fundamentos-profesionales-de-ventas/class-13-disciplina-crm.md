...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 08.12 — *Handoff a implementación*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de completitud de campos críticos para calcular la línea base. |
