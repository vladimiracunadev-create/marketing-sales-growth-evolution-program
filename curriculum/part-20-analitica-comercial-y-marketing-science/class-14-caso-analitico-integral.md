...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 20.13 — *Dashboards ejecutivos*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de cifras trazables para calcular la línea base. |
