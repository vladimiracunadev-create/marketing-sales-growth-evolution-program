...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 17.09 — *Integraciones*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de conversión por tramo para calcular la línea base. |
