...
1. **Distinguir** `ajuste de perfil`, `señal de intención`, `umbral de traspaso` y `retroalimentación de ventas` por sus observables y no por su definición memorizada.
...
4. **Operacionalizar** **tasa de aceptación por ventas**, **conversión a cliente por nivel de calificación** y **retroalimentación registrada** indicando numerador, denominador, ventana, fuente y uso permitido.
...
1. Explica la diferencia entre **ajuste de perfil** y **señal de intención** con un ejemplo donde elegir mal cambie la decisión.
2. ¿Qué observarías para validar **umbral de traspaso** y qué observación te obligaría a rechazar tu interpretación?
3. Aplica «definir criterios de perfil y de intención por separado» al caso de la clase. ¿Qué dato sigue faltando?
...
- `ficha-metricas.md` — definición operacional de **tasa de aceptación por ventas**, **conversión a cliente por nivel de calificación** y **retroalimentación registrada** con fuente, ventana y lectura prohibida.
...
← [Clase 11 · Captura de leads entrantes](class-11-inbound-lead-capture.md) · [Índice de la parte](README.md) · [Clase 13 · Secuencias multicanal](class-13-secuencias-multicanal.md) →
