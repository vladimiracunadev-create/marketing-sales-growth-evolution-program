...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 14.10 — *CPA, CAC y ROAS*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de consistencia de etiquetado para calcular la línea base. |
