...
Los conceptos que estructuran la sesión son **informe decisional**, **declaración de método**, **recomendación condicionada** y **auditabilidad**. No se estudian como lista de vocabulario: cada uno debe producir una predicción distinta sobre lo que ocurriría en la operación.
...
|---|---|---|
| 0–15 min | Recuperación | Define **informe decisional** y **declaración de método** sin mirar el material; corrige después con la tabla de conceptos. |
| 15–45 min | Núcleo conceptual | Lectura del desarrollo y construcción de la tabla `hecho / inferencia / supuesto`. |
| 45–75 min | Medición | Ficha de la señal **afirmaciones trazables**: fórmula, fuente, ventana y lectura prohibida. |
...
|---|---|---|
| **informe decisional** | documento estructurado alrededor de la decisión que debe informar y no del proceso realizado | Indica qué dato tendrías que ver para afirmarlo en una reunión de comité. |
| **declaración de método** | sección que describe fuentes, muestra, límites y fecha de la evidencia | Traduce el concepto en una pregunta que puedas hacerle a un cliente real. |
| **recomendación condicionada** | propuesta que explicita bajo qué supuestos es válida y qué la invalidaría | Da un hecho compatible con la definición y otro que la refute. |
| **auditabilidad** | posibilidad de que un tercero verifique cada afirmación hasta su fuente | Explica qué decisión cambiaría si el concepto estuviera ausente. |
...
**Frontera de aplicación.** Un informe no reemplaza la decisión ni la responsabilidad de quien decide. Su función es hacer explícito el razonamiento, no eliminar la incertidumbre.

## 📖 Desarrollo

### 1. Informe decisional: mecanismo central

**informe decisional** se entiende aquí como **documento estructurado alrededor de la decisión que debe informar y no del proceso realizado**. Es la pieza desde la que se inicia el análisis de informe de oportunidad de mercado: antes de «abrir con la decisión y la recomendación», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es William Ellet — *The Case Study Handbook* (2018, ed. revisada). **Lente que aporta:** análisis de casos: problema, decisión, evidencia y recomendación. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **afirmaciones trazables**; regístrala con periodo, unidad, población y línea base.
...
**Definición operacional:** sección que describe fuentes, muestra, límites y fecha de la evidencia. Su valor está en distinguirlo de **informe decisional**. En una decisión real, clasificar mal una situación cambia la intervención: se asigna presupuesto donde faltaba diagnóstico, se mide un resultado cuando había que observar un proceso, o se trata una restricción como si fuera una preferencia.

Contrasta el problema con Naresh K. Malhotra — *Marketing Research: An Applied Orientation* (2019, 7.ª ed.) —**lente:** diseño de investigación, muestreo, medición y análisis con rigor metodológico—. Formula dos mini-casos: uno que satisface la definición de **declaración de método** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **tiempo de lectura hasta la recomendación** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**recomendación condicionada** significa **propuesta que explicita bajo qué supuestos es válida y qué la invalidaría**. El problema ya no es definirlo sino medirlo: qué contar, en qué ventana, con qué denominador, contra qué línea base y con qué segmentación. Una métrica útil conserva contexto suficiente para no confundir una mejora local con una mejora del sistema.
...
### 4. Auditabilidad: trade-offs y efectos de segundo orden

**Definición:** posibilidad de que un tercero verifique cada afirmación hasta su fuente. Este concepto obliga a abandonar la idea de que informe de oportunidad de mercado tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «dimensionar la oportunidad con escenarios», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

Richard Rumelt — *Good Strategy / Bad Strategy* (2011) —**lente:** diagnóstico, política rectora y acción coherente frente a la estrategia decorativa— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **decisiones tomadas con el informe** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.

Haz un *pre-mortem*: supón que la opción recomendada fracasó a los seis meses y enumera tres mecanismos que lo expliquen. Al menos uno debe provenir de un efecto de segundo orden asociado a **auditabilidad** y otro de un supuesto del caso que nunca fue validado.
...
Sintetizar informe de oportunidad de mercado no consiste en sumar definiciones. Empieza por **informe decisional**, contrasta **declaración de método** con **recomendación condicionada**, incorpora **auditabilidad** como restricción y cierra con la medición. Aplica entonces la secuencia completa conservando tres columnas por paso: evidencia utilizada, alternativa descartada y razón del descarte.
...
|---|---|---|---|
| Actuar sobre **informe decisional** | Documento estructurado alrededor de la decisión que debe informar y no del proceso realizado | Cuando **afirmaciones trazables** es observable y accionable en el plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Actuar sobre **declaración de método** | Sección que describe fuentes, muestra, límites y fecha de la evidencia | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
...
| Nivel | Responsabilidad sobre informe de oportunidad de mercado |
|---|---|
...
El comité de Ruta Andina debe decidir entre abrir el vertical de centros médicos o profundizar en talleres. Tiene 40 minutos y necesita un documento que soporte preguntas duras.
...
2. Ejecuta la secuencia **abrir con la decisión y la recomendación → declarar método, muestra y límites → presentar tres insights con su implicancia → dimensionar la oportunidad con escenarios → cerrar con riesgos, condiciones de revisión y responsables** y adjunta evidencia en cada transición.
3. Construye la ficha de medición de **afirmaciones trazables**; si el dato no existe, diseña cómo obtenerlo y cuánto costaría.
...
Guarda en `evidence/P03-C14-informe-de-oportunidad-de-mercado/`:

- `decision-brief.md` — problema, evidencia, alternativas, recomendación y gobierno.
- `ficha-metricas.md` — definición operacional de **afirmaciones trazables**, **tiempo de lectura hasta la recomendación** y **decisiones tomadas con el informe** con fuente, ventana y lectura prohibida.
...
← [Clase 13 · Validación de hipótesis comerciales](class-13-validacion-de-hipotesis-comerciales.md) · [Índice de la parte](README.md)
