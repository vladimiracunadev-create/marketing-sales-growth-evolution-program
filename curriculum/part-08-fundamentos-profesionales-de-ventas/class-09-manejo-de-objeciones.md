...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 08.08 — *Propuestas comerciales*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de objeciones por negocio para calcular la línea base. |
