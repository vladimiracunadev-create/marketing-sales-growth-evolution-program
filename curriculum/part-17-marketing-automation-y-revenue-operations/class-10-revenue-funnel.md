...
sources: ["diorio", "croll-yoskovitz", "mehta", "kaplan-norton"]
updated: 2026-08-18
---

# Clase 17.10 — Embudo de ingresos
...
Los conceptos que estructuran la sesión son **embudo unificado**, **definición compartida por etapa**, **pérdida por tramo** y **visión de ciclo completo**. No se estudian como lista de vocabulario: cada uno debe producir una predicción distinta sobre lo que ocurriría en la operación.
...
|---|---|---|
| 0–15 min | Recuperación | Define **embudo unificado** y **definición compartida por etapa** sin mirar el material; corrige después con la tabla de conceptos. |
| 15–45 min | Núcleo conceptual | Lectura del desarrollo y construcción de la tabla `hecho / inferencia / supuesto`. |
| 45–75 min | Medición | Ficha de la señal **conversión por tramo**: fórmula, fuente, ventana y lectura prohibida. |
...
|---|---|---|
| **embudo unificado** | representación única del recorrido desde el descubrimiento hasta la renovación | Traduce el concepto en una pregunta que puedas hacerle a un cliente real. |
| **definición compartida por etapa** | criterio acordado entre áreas para cada estado del recorrido | Da un hecho compatible con la definición y otro que la refute. |
| **pérdida por tramo** | valor que se pierde en cada transición del embudo | Explica qué decisión cambiaría si el concepto estuviera ausente. |
| **visión de ciclo completo** | inclusión de retención y expansión en el análisis del embudo | Construye un caso límite donde el concepto se confunde con el anterior. |
...
**Frontera de aplicación.** Un embudo unificado puede ocultar diferencias importantes entre segmentos o líneas de negocio. El análisis debe segmentarse.

## 📖 Desarrollo

### 1. Embudo unificado: mecanismo central

**embudo unificado** se entiende aquí como **representación única del recorrido desde el descubrimiento hasta la renovación**. Es la pieza desde la que se inicia el análisis de embudo de ingresos: antes de «definir las etapas del recorrido completo», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es Stephen G. Diorio y Chris K. Hummel — *Revenue Operations* (2022). **Lente que aporta:** integración de datos, procesos y equipos que producen ingreso como un solo sistema. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **conversión por tramo**; regístrala con periodo, unidad, población y línea base.

Relaciona el mecanismo con **definición compartida por etapa**. Si ambos se mueven juntos no concluyas causalidad: nombra una tercera variable capaz de explicar el mismo patrón. El resultado de este bloque debe ser una hipótesis refutable, no una recomendación anticipada.

### 2. Definición compartida por etapa: frontera conceptual y error de clasificación

**Definición operacional:** criterio acordado entre áreas para cada estado del recorrido. Su valor está en distinguirlo de **embudo unificado**. En una decisión real, clasificar mal una situación cambia la intervención: se asigna presupuesto donde faltaba diagnóstico, se mide un resultado cuando había que observar un proceso, o se trata una restricción como si fuera una preferencia.

Contrasta el problema con Alistair Croll y Benjamin Yoskovitz — *Lean Analytics* (2013) —**lente:** una métrica que importa por etapa y por modelo de negocio—. Formula dos mini-casos: uno que satisface la definición de **definición compartida por etapa** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **valor perdido por tramo** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**pérdida por tramo** significa **valor que se pierde en cada transición del embudo**. El problema ya no es definirlo sino medirlo: qué contar, en qué ventana, con qué denominador, contra qué línea base y con qué segmentación. Una métrica útil conserva contexto suficiente para no confundir una mejora local con una mejora del sistema.
...
### 4. Visión de ciclo completo: trade-offs y efectos de segundo orden

**Definición:** inclusión de retención y expansión en el análisis del embudo. Este concepto obliga a abandonar la idea de que embudo de ingresos tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «identificar la mayor pérdida de valor», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

Robert S. Kaplan y David P. Norton — *The Balanced Scorecard* (1996) —**lente:** traducción de la estrategia en indicadores causalmente conectados— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **cobertura de definiciones compartidas** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.

Haz un *pre-mortem*: supón que la opción recomendada fracasó a los seis meses y enumera tres mecanismos que lo expliquen. Al menos uno debe provenir de un efecto de segundo orden asociado a **visión de ciclo completo** y otro de un supuesto del caso que nunca fue validado.
...
Robert S. Kaplan y David P. Norton — *The Balanced Scorecard* (1996) sirve para contrastar la recomendación final desde otro lente: traducción de la estrategia en indicadores causalmente conectados. La frontera de esta clase es explícita: Un embudo unificado puede ocultar diferencias importantes entre segmentos o líneas de negocio. El análisis debe segmentarse. Conviértela en una regla operativa con el formato `si ocurre X → no aplicar automáticamente → consultar, escalar o revalidar`.
...
Sintetizar embudo de ingresos no consiste en sumar definiciones. Empieza por **embudo unificado**, contrasta **definición compartida por etapa** con **pérdida por tramo**, incorpora **visión de ciclo completo** como restricción y cierra con la medición. Aplica entonces la secuencia completa conservando tres columnas por paso: evidencia utilizada, alternativa descartada y razón del descarte.
...
|---|---|---|---|
| Actuar sobre **embudo unificado** | Representación única del recorrido desde el descubrimiento hasta la renovación | Cuando **conversión por tramo** es observable y accionable en el plazo de la decisión. | Sobrerreaccionar a una señal parcial. |
| Actuar sobre **definición compartida por etapa** | Criterio acordado entre áreas para cada estado del recorrido | Cuando la primera explicación no distingue mecanismo ni responsable. | Convertir el concepto en etiqueta y no en intervención. |
...
| Nivel | Responsabilidad sobre embudo de ingresos |
|---|---|
...
El embudo de Ruta Andina termina en la firma. La mayor pérdida de valor ocurre entre la firma y el día 90, y no aparece en ningún informe.
...
2. Ejecuta la secuencia **definir las etapas del recorrido completo → acordar criterios entre áreas → medir volumen, conversión y valor por tramo → identificar la mayor pérdida de valor → asignar responsable por tramo** y adjunta evidencia en cada transición.
3. Construye la ficha de medición de **conversión por tramo**; si el dato no existe, diseña cómo obtenerlo y cuánto costaría.
...
Guarda en `evidence/P17-C10-revenue-funnel/`:

- `decision-brief.md` — problema, evidencia, alternativas, recomendación y gobierno.
- `ficha-metricas.md` — definición operacional de **conversión por tramo**, **valor perdido por tramo** y **cobertura de definiciones compartidas** con fuente, ventana y lectura prohibida.
...
← [Clase 09 · Integraciones](class-09-integraciones.md) · [Índice de la parte](README.md) · [Clase 11 · Forecast unificado](class-11-forecast-unificado.md) →
