...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 07.10 — *Freemium y pruebas gratuitas*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de descuento promedio ponderado para calcular la línea base. |
