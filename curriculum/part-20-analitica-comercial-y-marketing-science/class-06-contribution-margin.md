...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 20.05 — *Periodo de recuperación*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de margen de contribución por segmento para calcular la línea base. |
