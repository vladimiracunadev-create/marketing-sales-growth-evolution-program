...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 20.07 — *Análisis de cohortes aplicado*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de variación de crédito entre modelos para calcular la línea base. |
