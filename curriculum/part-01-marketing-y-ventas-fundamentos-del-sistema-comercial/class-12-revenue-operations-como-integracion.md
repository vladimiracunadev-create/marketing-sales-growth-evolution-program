...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 01.11 — *Customer Success y expansión*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de discrepancia entre informes para calcular la línea base. |
