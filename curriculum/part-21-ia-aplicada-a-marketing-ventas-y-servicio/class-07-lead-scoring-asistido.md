...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 21.06 — *Investigación de prospectos asistida*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de desempeño frente a la regla actual para calcular la línea base. |
