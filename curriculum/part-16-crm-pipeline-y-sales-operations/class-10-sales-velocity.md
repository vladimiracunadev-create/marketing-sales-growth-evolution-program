...
**velocidad comercial** se entiende aquí como **resultado de combinar oportunidades, valor, tasa de cierre y duración del ciclo**. Es la pieza desde la que se inicia el análisis de velocidad comercial: antes de «calcular las cuatro variables con datos propios», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es Mark Roberge — *The Sales Acceleration Formula* (2015). **Lente que aporta:** contratación, formación, gestión y demanda comercial gobernadas por datos. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **duración mediana del ciclo**; regístrala con periodo, unidad, población y línea base.
...
**Definición operacional:** variable cuya mejora produce mayor efecto sobre el resultado. Su valor está en distinguirlo de **velocidad comercial**. En una decisión real, clasificar mal una situación cambia la intervención: se asigna presupuesto donde faltaba diagnóstico, se mide un resultado cuando había que observar un proceso, o se trata una restricción como si fuera una preferencia.

Contrasta el problema con Andrew S. Grove — *High Output Management* (1983) —**lente:** output gerencial, indicadores adelantados y reuniones como herramienta de producción—. Formula dos mini-casos: uno que satisface la definición de **palanca dominante** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **valor promedio de oportunidad** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**duración del ciclo** significa **tiempo entre la creación de la oportunidad y su cierre**. El problema ya no es definirlo sino medirlo: qué contar, en qué ventana, con qué denominador, contra qué línea base y con qué segmentación. Una métrica útil conserva contexto suficiente para no confundir una mejora local con una mejora del sistema.
...
**Definición:** resultado de mejorar varias variables simultáneamente. Este concepto obliga a abandonar la idea de que velocidad comercial tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «intervenir sobre esa palanca», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

Robert B. Miller y Stephen E. Heiman — *The New Strategic Selling* (2005) —**lente:** mapa de influencias, roles de compra y análisis de posición en cuentas complejas— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **velocidad comercial calculada** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.
...
Robert B. Miller y Stephen E. Heiman — *The New Strategic Selling* (2005) sirve para contrastar la recomendación final desde otro lente: mapa de influencias, roles de compra y análisis de posición en cuentas complejas. La frontera de esta clase es explícita: Acelerar el ciclo puede reducir la calidad del diagnóstico y aumentar el churn posterior. La velocidad debe evaluarse junto con la retención. Conviértela en una regla operativa con el formato `si ocurre X → no aplicar automáticamente → consultar, escalar o revalidar`.
...
2. Ejecuta la secuencia **calcular las cuatro variables con datos propios → simular el efecto de mejorar cada una por separado → identificar la palanca dominante y su costo → intervenir sobre esa palanca → medir el efecto y recalcular** y adjunta evidencia en cada transición.
3. Construye la ficha de medición de **duración mediana del ciclo**; si el dato no existe, diseña cómo obtenerlo y cuánto costaría.
