...
1. **Distinguir** `aporte previo`, `calidad del asistente`, `plan de seguimiento` y `costo por oportunidad del evento` por sus observables y no por su definición memorizada.
...
4. **Operacionalizar** **proporción de asistentes en perfil**, **costo por oportunidad calificada** y **tasa de seguimiento en 72 horas** indicando numerador, denominador, ventana, fuente y uso permitido.
...
**aporte previo** se entiende aquí como **contenido o servicio útil entregado antes de cualquier petición comercial**. Es la pieza desde la que se inicia el análisis de eventos y comunidades: antes de «seleccionar el evento por perfil de asistente y no por tamaño», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es Seth Godin — *This Is Marketing* (2018). **Lente que aporta:** marketing como servicio a un público mínimo viable y construcción de confianza. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **proporción de asistentes en perfil**; regístrala con periodo, unidad, población y línea base.
...
Contrasta el problema con Gabriel Weinberg y Justin Mares — *Traction* (2015) —**lente:** diecinueve canales de tracción y el método bullseye de priorización—. Formula dos mini-casos: uno que satisface la definición de **calidad del asistente** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **costo por oportunidad calificada** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**plan de seguimiento** significa **secuencia definida de contacto posterior con responsables y plazos**. El problema ya no es definirlo sino medirlo: qué contar, en qué ventana, con qué denominador, contra qué línea base y con qué segmentación. Una métrica útil conserva contexto suficiente para no confundir una mejora local con una mejora del sistema.
...
**Definición:** inversión total dividida por oportunidades calificadas originadas. Este concepto obliga a abandonar la idea de que eventos y comunidades tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «ejecutar el seguimiento dentro de las 72 horas», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

Jeb Blount — *Fanatical Prospecting* (2015) —**lente:** disciplina de prospección, cadencia y gestión del rechazo— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **tasa de seguimiento en 72 horas** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.
...
Jeb Blount — *Fanatical Prospecting* (2015) sirve para contrastar la recomendación final desde otro lente: disciplina de prospección, cadencia y gestión del rechazo. La frontera de esta clase es explícita: La captura de datos en eventos exige información clara sobre finalidad y consentimiento. Un sorteo no es base suficiente para enviar comunicaciones comerciales indefinidas. Conviértela en una regla operativa con el formato `si ocurre X → no aplicar automáticamente → consultar, escalar o revalidar`.
...
2. Ejecuta la secuencia **seleccionar el evento por perfil de asistente y no por tamaño → diseñar un aporte de valor concreto → capturar contactos con consentimiento y contexto → ejecutar el seguimiento dentro de las 72 horas → medir el costo por oportunidad y por cliente ganado** y adjunta evidencia en cada transición.
3. Construye la ficha de medición de **proporción de asistentes en perfil**; si el dato no existe, diseña cómo obtenerlo y cuánto costaría.
...
1. Explica la diferencia entre **aporte previo** y **calidad del asistente** con un ejemplo donde elegir mal cambie la decisión.
2. ¿Qué observarías para validar **plan de seguimiento** y qué observación te obligaría a rechazar tu interpretación?
3. Aplica «seleccionar el evento por perfil de asistente y no por tamaño» al caso de la clase. ¿Qué dato sigue faltando?
4. ¿Por qué **proporción de asistentes en perfil** no basta por sí sola para atribuir causalidad?
5. Compara dos fuentes de la lectura comparada: ¿dónde llevarían a recomendaciones distintas?
6. ¿Qué decisión equivocada se produciría si se ignora este límite: «La captura de datos en eventos exige información clara sobre finalidad y consentimiento. Un sorteo no es base suficiente para enviar comunicaciones comerciales indefinidas»?
...
- `ficha-metricas.md` — definición operacional de **proporción de asistentes en perfil**, **costo por oportunidad calificada** y **tasa de seguimiento en 72 horas** con fuente, ventana y lectura prohibida.
...
← [Clase 08 · Referidos](class-08-referidos.md) · [Índice de la parte](README.md) · [Clase 10 · Lead magnets](class-10-lead-magnets.md) →
