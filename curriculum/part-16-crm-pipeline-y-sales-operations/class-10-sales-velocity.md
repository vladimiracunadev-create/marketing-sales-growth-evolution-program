...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 16.09 — *Capacidad comercial*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de duración mediana del ciclo para calcular la línea base. |
