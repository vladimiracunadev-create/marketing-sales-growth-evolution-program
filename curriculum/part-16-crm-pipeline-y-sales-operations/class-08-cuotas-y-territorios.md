...
**cuota** se entiende aquí como **meta individual de resultado asignada para un periodo**. Es la pieza desde la que se inicia el análisis de cuotas y territorios: antes de «estimar el potencial por territorio con datos», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es Andris A. Zoltners, Prabhakant Sinha y Sally E. Lorimer — *The Complete Guide to Sales Force Incentive Compensation* (2006). **Lente que aporta:** diseño de cuotas, territorios e incentivos sin efectos perversos. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **proporción del equipo que alcanza la cuota**; regístrala con periodo, unidad, población y línea base.
...
**Definición operacional:** conjunto de cuentas o zona asignada a un vendedor. Su valor está en distinguirlo de **cuota**. En una decisión real, clasificar mal una situación cambia la intervención: se asigna presupuesto donde faltaba diagnóstico, se mide un resultado cuando había que observar un proceso, o se trata una restricción como si fuera una preferencia.

Contrasta el problema con Mark Roberge — *The Sales Acceleration Formula* (2015) —**lente:** contratación, formación, gestión y demanda comercial gobernadas por datos—. Formula dos mini-casos: uno que satisface la definición de **territorio** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **dispersión de potencial entre territorios** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**equidad de oportunidad** significa **grado en que los territorios ofrecen potencial comparable**. El problema ya no es definirlo sino medirlo: qué contar, en qué ventana, con qué denominador, contra qué línea base y con qué segmentación. Una métrica útil conserva contexto suficiente para no confundir una mejora local con una mejora del sistema.
...
**Definición:** proporción del equipo que puede alcanzar la cuota con desempeño normal. Este concepto obliga a abandonar la idea de que cuotas y territorios tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «verificar la alcanzabilidad histórica», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

Jim Collins — *Good to Great* (2001) —**lente:** disciplina, personas correctas y concepto del erizo aplicados a la ejecución comercial— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **rotación por territorio** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.
...
Jim Collins — *Good to Great* (2001) sirve para contrastar la recomendación final desde otro lente: disciplina, personas correctas y concepto del erizo aplicados a la ejecución comercial. La frontera de esta clase es explícita: La equidad perfecta de territorios no existe. El objetivo es que las diferencias sean conocidas y compensadas explícitamente en la cuota. Conviértela en una regla operativa con el formato `si ocurre X → no aplicar automáticamente → consultar, escalar o revalidar`.
...
2. Ejecuta la secuencia **estimar el potencial por territorio con datos → distribuir territorios buscando equidad de potencial → derivar la cuota del potencial y no del deseo → verificar la alcanzabilidad histórica → revisar la asignación cada año con datos de resultado** y adjunta evidencia en cada transición.
3. Construye la ficha de medición de **proporción del equipo que alcanza la cuota**; si el dato no existe, diseña cómo obtenerlo y cuánto costaría.
