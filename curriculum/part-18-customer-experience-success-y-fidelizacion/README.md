...
| 03 | [Time to value](class-03-time-to-value.md) | primer valor, tiempo hasta el primer valor, bloqueador de implementación |
| 04 | [Customer Success](class-04-customer-success.md) | función proactiva, resultado del cliente, modelo de cobertura |
| 05 | [Health score](class-05-health-score.md) | componente de uso, componente de resultado, validación predictiva |
| 06 | [NPS, CSAT y CES](class-06-nps-csat-y-ces.md) | indicador de recomendación, satisfacción transaccional, indicador de esfuerzo |
| 07 | [Churn](class-07-churn.md) | churn de clientes, churn de ingreso, motivo declarado frente a causa raíz |
| 08 | [Retención](class-08-retention.md) | curva de retención, retención estabilizada, componente controlable |
| 09 | [Análisis de cohortes](class-09-cohortes.md) | cohorte, seguimiento longitudinal, efecto de mezcla |
| 10 | [Renovación](class-10-renewal.md) | ciclo de renovación, evidencia de resultado, riesgo de renovación |
| 11 | [Ingreso por expansión](class-11-expansion-revenue.md) | expansión legítima, señal de expansión, ingreso neto retenido |
| 12 | [Advocacy y referidos](class-12-advocacy-y-referidos.md) | promotor, momento de la petición, facilitación de la referencia |
