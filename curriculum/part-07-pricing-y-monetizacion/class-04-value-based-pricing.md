...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 07.03 — *Pricing por competencia*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de valor diferencial verificado para calcular la línea base. |
