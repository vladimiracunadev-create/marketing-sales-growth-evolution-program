...
**etapa del journey** se entiende aquí como **momento definido por el objetivo del cliente y no por el canal que la empresa usa**. Es la pieza desde la que se inicia el análisis de customer journey: antes de «definir las etapas desde la perspectiva del cliente», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es Matthew Dixon, Nick Toman y Rick DeLisi — *The Effortless Experience* (2013). **Lente que aporta:** reducción del esfuerzo del cliente como motor de lealtad frente al deleite. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **esfuerzo percibido por etapa**; regístrala con periodo, unidad, población y línea base.
...
**Definición operacional:** fricción concreta que aumenta esfuerzo, riesgo o tiempo del cliente en una etapa. Su valor está en distinguirlo de **etapa del journey**. En una decisión real, clasificar mal una situación cambia la intervención: se asigna presupuesto donde faltaba diagnóstico, se mide un resultado cuando había que observar un proceso, o se trata una restricción como si fuera una preferencia.

Contrasta el problema con Steve Krug — *Don't Make Me Think, Revisited* (2014) —**lente:** usabilidad, claridad y pruebas baratas con usuarios reales—. Formula dos mini-casos: uno que satisface la definición de **punto de dolor** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **abandono por etapa** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**momento de la verdad** significa **interacción que define desproporcionadamente la percepción de toda la relación**. El problema ya no es definirlo sino medirlo: qué contar, en qué ventana, con qué denominador, contra qué línea base y con qué segmentación. Una métrica útil conserva contexto suficiente para no confundir una mejora local con una mejora del sistema.
...
**Definición:** diferencia entre lo que el cliente esperaba y lo que efectivamente recibió. Este concepto obliga a abandonar la idea de que customer journey tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «medir esfuerzo o abandono en cada uno», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

Philip Kotler, Kevin Lane Keller y Alexander Chernev — *Marketing Management* (2021, 16.ª ed.) —**lente:** estructura canónica del marketing: análisis, STP, mezcla comercial y gestión de la demanda— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **brecha de expectativa en onboarding** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.
...
Philip Kotler, Kevin Lane Keller y Alexander Chernev — *Marketing Management* (2021, 16.ª ed.) sirve para contrastar la recomendación final desde otro lente: estructura canónica del marketing: análisis, STP, mezcla comercial y gestión de la demanda. La frontera de esta clase es explícita: El journey promedio puede no existir: si el mapa mezcla segmentos con recorridos distintos, producirá intervenciones que no sirven a ninguno. Conviértela en una regla operativa con el formato `si ocurre X → no aplicar automáticamente → consultar, escalar o revalidar`.
...
2. Ejecuta la secuencia **definir las etapas desde la perspectiva del cliente → documentar objetivo, información buscada y fricción por etapa → identificar los momentos de la verdad → medir esfuerzo o abandono en cada uno → priorizar intervenciones por costo y efecto** y adjunta evidencia en cada transición.
3. Construye la ficha de medición de **esfuerzo percibido por etapa**; si el dato no existe, diseña cómo obtenerlo y cuánto costaría.
