...
| 03 | [AARRR](class-03-aarrr.md) | etapa del marco, cuello de botella, orden de intervención |
| 04 | [Growth loops](class-04-growth-loops.md) | bucle de crecimiento, output del usuario, velocidad del bucle |
| 05 | [Activación](class-05-activation.md) | evento de activación, ventana de activación, análisis predictivo de activación |
| 06 | [Crecimiento centrado en retención](class-06-retention-first-growth.md) | curva estabilizada, orden de inversión, costo de la fuga |
| 07 | [Bucles de referencia](class-07-referral-loops.md) | condición de valor previo, mecanismo de compartir, incentivo bilateral |
| 08 | [Viralidad](class-08-viralidad.md) | coeficiente viral, tiempo de ciclo viral, viralidad parcial |
| 09 | [Backlog de experimentos](class-09-experiment-backlog.md) | entrada del backlog, fundamento de la hipótesis, esfuerzo estimado |
| 10 | [ICE, RICE y priorización](class-10-ice-rice-y-priorizacion.md) | impacto estimado, confianza, esfuerzo |
| 11 | [Diseño de experimentos](class-11-experiment-design.md) | asignación comparable, tamaño mínimo detectable, métrica guardarraíl |
| 12 | [Growth engineering](class-12-growth-engineering.md) | instrumentación, bandera de funcionalidad, infraestructura de experimentos |
