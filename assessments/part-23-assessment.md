...
1. Define **especialización** de forma operacional y da un hecho que lo confirme y otro que lo refute. Definición de referencia: *división del trabajo comercial en roles con foco definido*.
2. Define **resultado del rol** de forma operacional y da un hecho que lo confirme y otro que lo refute. Definición de referencia: *output medible por el que la persona responde*.
3. Define **perfil basado en datos** de forma operacional y da un hecho que lo confirme y otro que lo refute. Definición de referencia: *conjunto de características derivadas del desempeño observado en la empresa*.
4. Define **rampa de productividad** de forma operacional y da un hecho que lo confirme y otro que lo refute. Definición de referencia: *tiempo hasta alcanzar el desempeño objetivo del rol*.
5. Define **estructura de compensación** de forma operacional y da un hecho que lo confirme y otro que lo refute. Definición de referencia: *combinación de fijo, variable y aceleradores del esquema*.
...
1. Consolidar estructura, roles y responsabilidades.
2. Documentar plan, presupuesto y objetivos.
3. Establecer el ritmo de gestión y sus reuniones.
4. Definir incentivos, desarrollo y gobierno.
5. Verificar la independencia con una prueba de ausencia.

Debes operacionalizar **decisiones tomadas sin escalamiento**, **detección temprana de desvíos** y **continuidad ante ausencias**. Separa hechos, inferencias y supuestos: una métrica sin línea base ni ventana no cuenta como evidencia suficiente.
...
> **Riesgo declarado:** Escalar un motor roto, generar rotación y destruir el margen mientras se «crece».
...
[⬅ Clases de la parte](../curriculum/part-23-direccion-comercial-cmo-vp-sales-y-cro/README.md) · [Laboratorios](../labs/part-23/) · [Caso extendido](../cases/)
