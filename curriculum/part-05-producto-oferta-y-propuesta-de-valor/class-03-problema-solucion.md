...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 05.02 — *Value Proposition Canvas*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de costo del problema declarado para calcular la línea base. |
