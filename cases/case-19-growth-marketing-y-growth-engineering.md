...
- verificación del riesgo: declarar victorias con muestras insuficientes y optimizar métricas locales que dañan el sistema.
...
Este caso integra la parte 19 y en particular la clase 19.14 — Growth model completo. Su artefacto alimenta **growth model con North Star, bucles, backlog priorizado y resultados de experimentos**.

---

[⬅ Clases](../curriculum/part-19-growth-marketing-y-growth-engineering/README.md) · [Laboratorios](../labs/part-19/) · [Evaluación](../assessments/part-19-assessment.md)
