...
> **¿Qué unidad de resultado estoy comprando y a qué costo marginal deja de tener sentido?**

Esa pregunta no es retórica: al final de la parte tienes que poder responderla con un artefacto en la mano —plan de performance con estructura de campañas, presupuestos, medición y salvaguardas— y no con una opinión.
...
Las competencias que se desarrollan aquí son **gestión de subastas**, **economía de campañas** y **medición y brand safety**. Con ellas la parte habilita para el trabajo de Performance marketer, Media buyer y Growth marketer, que es donde estas decisiones se toman de verdad.
...
Leer la parte no la acredita. Los [laboratorios](../../labs/part-14/) te hacen ejecutar el método sobre el caso; la [evaluación de la parte](../../assessments/part-14-assessment.md) comprueba que puedes sostener las decisiones sin el material delante; el [caso extendido](../../cases/) exige integrar lo aprendido en una recomendación completa, y en [`templates/`](../../templates/) están los formatos que se usan para producir el artefacto. El resultado que va a tu portafolio es **plan de performance con estructura de campañas, presupuestos, medición y salvaguardas**.

## Qué puede salir mal

Atribuirse demanda existente, inflar el retorno y decidir presupuesto sobre una ilusión. Antes de llevar cualquier recomendación de esta parte a una operación real, revisa el [mapa regulatorio](../../docs/MAPA-REGULATORIO-CHILE.md) y las [reglas sobre datos personales](../../docs/DATOS-PERSONALES-Y-ETICA.md): la norma vigente manda sobre el material pedagógico.
