...
> **¿Cuánto vale esto para quién, y qué estructura de cobro alinea precio con valor entregado?**

Esa pregunta no es retórica: al final de la parte tienes que poder responderla con un artefacto en la mano —arquitectura de monetización con métrica de cobro, planes, price fences y política de descuentos— y no con una opinión.

## Sobre qué caso vas a trabajar

Ruta Andina cobra por local y sus mejores clientes tienen varios locales pequeños. Los descuentos por cierre de mes ya se volvieron una expectativa.
...
Las competencias que se desarrollan aquí son **pricing basado en valor**, **análisis de disposición a pagar** y **unit economics**. Con ellas la parte habilita para el trabajo de Pricing manager, Product marketing, CFO comercial y Founder, que es donde estas decisiones se toman de verdad.
...
|---|---|---|
| 01 | [El precio como decisión estratégica](class-01-precio-como-decision-estrategica.md) | apalancamiento del precio, política de precios, métrica de cobro |
| 02 | [Pricing por costo](class-02-cost-plus-pricing.md) | costo variable unitario, costo de servir completo, margen objetivo |
| 03 | [Pricing por competencia](class-03-competitor-based-pricing.md) | precio de referencia competitivo, comparabilidad real, guerra de precios |
| 04 | [Pricing basado en valor](class-04-value-based-pricing.md) | valor de referencia, valor diferencial, regla de captura |
| 05 | [Disposición a pagar](class-05-willingness-to-pay.md) | distribución de disposición a pagar, sesgo de declaración, análisis de compensación |
| 06 | [Elasticidad y sensibilidad al precio](class-06-elasticidad-y-sensibilidad.md) | elasticidad precio, factor de sensibilidad, segmentación de sensibilidad |
| 07 | [Van Westendorp y técnicas de investigación de precio](class-07-van-westendorp-y-tecnicas-de-investigacion.md) | rango de precios aceptable, punto de precio óptimo, técnica de compensación |
| 08 | [Versionado y price fences](class-08-versionado-y-price-fences.md) | price fence, versionado, arbitraje entre segmentos |
| 09 | [Suscripción e ingreso recurrente](class-09-suscripcion-y-recurring-revenue.md) | ingreso recurrente, periodo de recuperación, renovación automática |
| 10 | [Freemium y pruebas gratuitas](class-10-freemium-y-pruebas-gratuitas.md) | freemium, prueba gratuita, costo marginal de servir gratis |
| 11 | [Descuentos sin destruir valor](class-11-descuentos-sin-destruir-valor.md) | contrapartida, autoridad de descuento, erosión de precio |
| 12 | [Unit economics](class-12-unit-economics.md) | costo de adquisición completo, margen de contribución por cliente, periodo de recuperación |
| 13 | [Experimentación de precios](class-13-experimentacion-de-precios.md) | grupo de comparación, métrica guardrail, duración mínima |
| 14 | [Arquitectura de monetización](class-14-arquitectura-de-monetizacion.md) | arquitectura de monetización, coherencia precio-valor, gobierno de precios |

## Dónde se practica y cómo se evalúa

Leer la parte no la acredita. Los [laboratorios](../../labs/part-07/) te hacen ejecutar el método sobre el caso; la [evaluación de la parte](../../assessments/part-07-assessment.md) comprueba que puedes sostener las decisiones sin el material delante; el [caso extendido](../../cases/) exige integrar lo aprendido en una recomendación completa, y en [`templates/`](../../templates/) están los formatos que se usan para producir el artefacto. El resultado que va a tu portafolio es **arquitectura de monetización con métrica de cobro, planes, price fences y política de descuentos**.

## Qué puede salir mal

Erosionar precio con descuentos tácticos y perder capacidad de subir precios después. Antes de llevar cualquier recomendación de esta parte a una operación real, revisa el [mapa regulatorio](../../docs/MAPA-REGULATORIO-CHILE.md) y las [reglas sobre datos personales](../../docs/DATOS-PERSONALES-Y-ETICA.md): la norma vigente manda sobre el material pedagógico.
