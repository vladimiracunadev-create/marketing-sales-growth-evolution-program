...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 08.04 — *Discovery*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tasa de descalificación temprana para calcular la línea base. |
