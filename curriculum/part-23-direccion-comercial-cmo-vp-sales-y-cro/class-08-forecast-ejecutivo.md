...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 23.07 — *OKR y KPI*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de precisión histórica del forecast para calcular la línea base. |
