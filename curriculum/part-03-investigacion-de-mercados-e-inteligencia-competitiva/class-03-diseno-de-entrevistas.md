...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 03.02 — *Fuentes primarias y secundarias*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de proporción de hechos sobre opiniones para calcular la línea base. |
