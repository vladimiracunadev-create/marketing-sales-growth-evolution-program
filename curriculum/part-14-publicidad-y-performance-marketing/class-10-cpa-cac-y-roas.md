...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 14.09 — *CTR, CPC y CPM*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de costo de adquisición completo por canal para calcular la línea base. |
