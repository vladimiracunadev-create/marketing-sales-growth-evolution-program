...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 21.08 — *Copilotos de ventas*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de acciones ejecutadas por el agente para calcular la línea base. |
