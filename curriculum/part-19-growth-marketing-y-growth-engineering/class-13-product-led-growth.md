...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 19.12 — *Growth engineering*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de tasa de conversión autoservicio para calcular la línea base. |
