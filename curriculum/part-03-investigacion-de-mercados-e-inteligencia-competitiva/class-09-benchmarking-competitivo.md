...
**tabla de entrada** se entiende aquí como **atributo que todos los competidores ofrecen y cuya ausencia descalifica**. Es la pieza desde la que se inicia el análisis de benchmarking competitivo: antes de «elegir los atributos que el cliente usa para decidir», hay que poder señalar qué cambia en la operación si el concepto está presente y qué debería observarse si no lo está.

La lectura rectora de este bloque es Michael E. Porter — *Competitive Strategy* (1980). **Lente que aporta:** estructura de industria, fuerzas competitivas y elección de una posición defendible. Úsala sin convertirla en dogma: escribe una proposición de la obra que apoye tu diagnóstico, una condición del caso que la limite y una consecuencia práctica. La evidencia mínima es **brecha por atributo crítico**; regístrala con periodo, unidad, población y línea base.
...
**Definición operacional:** atributo donde la empresa supera de forma perceptible y sostenible a las alternativas. Su valor está en distinguirlo de **tabla de entrada**. En una decisión real, clasificar mal una situación cambia la intervención: se asigna presupuesto donde faltaba diagnóstico, se mide un resultado cuando había que observar un proceso, o se trata una restricción como si fuera una preferencia.

Contrasta el problema con Michael E. Porter — *What Is Strategy? (Harvard Business Review)* (1996) —**lente:** estrategia como sistema de actividades coherentes y elección explícita de qué no hacer—. Formula dos mini-casos: uno que satisface la definición de **punto de diferencia** y otro que sólo se le parece en la superficie. Después pregunta qué señal los distingue; **tasa de pérdida por atributo** es candidata, pero debe combinarse con evidencia cualitativa cuando el fenómeno no es directamente medible.
...
**brecha de desempeño** significa **diferencia medida entre la empresa y el mejor competidor en un atributo concreto**. El problema ya no es definirlo sino medirlo: qué contar, en qué ventana, con qué denominador, contra qué línea base y con qué segmentación. Una métrica útil conserva contexto suficiente para no confundir una mejora local con una mejora del sistema.
...
W. Chan Kim y Renée Mauborgne — *Blue Ocean Strategy* (2015, ed. ampliada) orienta este bloque —**lente:** reconstrucción de las fronteras del mercado y curva de valor—. Pregúntate si el indicador es adelantado o rezagado y si puede ser manipulado por quienes son evaluados con él. La medición debe informar una decisión; en el momento en que reemplaza al fenómeno, deja de servir.

### 4. Costo de cierre de brecha: trade-offs y efectos de segundo orden

**Definición:** recursos necesarios para alcanzar el nivel del competidor en ese atributo. Este concepto obliga a abandonar la idea de que benchmarking competitivo tiene una solución gratuita. Toda intervención consume caja, tiempo, atención del equipo, capacidad de la operación, reputación o tolerancia al riesgo. Por eso, antes de «estimar el costo de cerrar cada brecha relevante», se comparan al menos dos alternativas plausibles y se explicita qué se sacrifica en cada una.

Al Ries y Jack Trout — *Positioning: The Battle for Your Mind* (2001, ed. revisada) —**lente:** posicionamiento como lugar en la mente del cliente y no como declaración interna— sirve para construir una matriz `beneficio esperado / costo / reversibilidad / stakeholder afectado / señal temprana`. La evidencia **costo estimado de paridad** ayuda a detectar si el trade-off está ocurriendo como se esperaba, pero no elimina la obligación de observar efectos laterales fuera del indicador principal.
...
Al Ries y Jack Trout — *Positioning: The Battle for Your Mind* (2001, ed. revisada) sirve para contrastar la recomendación final desde otro lente: posicionamiento como lugar en la mente del cliente y no como declaración interna. La frontera de esta clase es explícita: El benchmarking mira el presente del competidor, no su dirección. Igualar hoy puede significar llegar tarde mañana si el competidor está construyendo otra cosa. Conviértela en una regla operativa con el formato `si ocurre X → no aplicar automáticamente → consultar, escalar o revalidar`.
...
2. Ejecuta la secuencia **elegir los atributos que el cliente usa para decidir → medir a la empresa y a los competidores en cada uno → clasificar cada atributo como tabla de entrada o diferencia → estimar el costo de cerrar cada brecha relevante → decidir dónde igualar y dónde diferenciarse deliberadamente** y adjunta evidencia en cada transición.
3. Construye la ficha de medición de **brecha por atributo crítico**; si el dato no existe, diseña cómo obtenerlo y cuánto costaría.
