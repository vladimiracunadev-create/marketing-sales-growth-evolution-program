...
| Requisito | Detalle |
|---|---|
| **Qué debes traer resuelto** | La clase 17.01 — *Automatización con propósito*, cuyo entregable se reutiliza aquí. |
| **Con qué datos trabajarás** | Los del caso de la clase; si usas datos propios, necesitas al menos una serie histórica de distribución por etapa para calcular la línea base. |
